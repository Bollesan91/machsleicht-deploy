#!/usr/bin/env python3
"""
Extract Feuerwehr 3-5 Elite page to structured JSON. (Phase C #2: feuerwehr-klein)
...
SRC = 'kindergeburtstag/feuerwehr-3-5-jahre.html'
...
# Write result
# ============================================================
out_path = '_src/elite-motto-data/feuerwehr-klein.json'
