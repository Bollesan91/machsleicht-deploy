...
SRC = 'kindergeburtstag/einhorn-9-12-jahre.html'
...
# ============================================================
age_match = re.search(
    r'<h3[^>]*>🧠 Was du über 9–12-Jährige wissen musst.*?</h3>(.*?)<h3',
    html, re.DOTALL)
if age_match:
    ...
    result['ageInsight'] = {
        'headline': 'Was du über 9–12-Jährige wissen musst — Einhorn-Party 9-12',
...
# Write result
# ============================================================
out_path = '_src/elite-motto-data/einhorn-gross.json'
