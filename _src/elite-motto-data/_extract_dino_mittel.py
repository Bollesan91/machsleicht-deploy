#!/usr/bin/env python3
"""
Extract Dino 6-8 Elite page (Phase C #6: safari-mittel, NO ritual block)
...
SRC = 'kindergeburtstag/dino-6-8-jahre.html'
...
# Write result
# ============================================================
out_path = '_src/elite-motto-data/dino-mittel.json'
