#!/usr/bin/env python3
"""
Extract Feuerwehr 9-12 Elite page (Phase C #3: feuerwehr-gross)
...
SRC = 'kindergeburtstag/feuerwehr-9-12-jahre.html'
...
def extract_variant(variant_id, variant_label):
    ...
    for i, (h4_pos, h4_m) in enumerate(h4_starts):
        ...
        for key, val in markers.items():
            ...
            elif 'für 11' in k or '11-jährig' in k or 'für 12' in k or '12-jährig' in k: age8 = val
...
# ============================================================
cake = re.search(r'<h2[^>]*>🎂 Feuerwehrauto-Kuchen[^<]*</h2>(.*?)<h2', html, re.DOTALL)
if cake:
...
# Write result
# ============================================================
out_path = '_src/elite-motto-data/feuerwehr-gross.json'
