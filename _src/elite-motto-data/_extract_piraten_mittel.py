#!/usr/bin/env python3
"""
Extract Piraten 6-8 Elite page (entity-encoded HTML) (Phase C #6: safari-mittel, NO ritual block)
...
SRC = 'kindergeburtstag/piraten-6-8-jahre.html'
...
# Write result
# ============================================================
out_path = '_src/elite-motto-data/piraten-mittel.json'
