...
SRC_JSON = '/tmp/machsleicht-deploy/_src/elite-motto-data/feuerwehr-mittel.json'
SRC_HTML = '/tmp/machsleicht-deploy/kindergeburtstag/feuerwehr-6-8-jahre.html'
...
cake_html_match = re.search(
    r'<h2[^>]*>🎂 Feuerwehrauto-Kuchen.*?</h2>(.*?)<h2',
    html, re.DOTALL)
