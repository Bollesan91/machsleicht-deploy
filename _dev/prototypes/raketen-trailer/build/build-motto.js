...
const MOTTOS = {
  ...
  dino: { title: 'Dino-Trailer', emoji: '🦕', dur: 24,
    lede: 'Expedition ins Dinotal: 24 Sekunden Einladung, komplett auf deinem Gerät gerechnet, mit Ton. Tipp auf <b>MP4 erzeugen</b>, warte auf das Video und mach dann einen Screenshot vom Testprotokoll.',
    theme: '--ground:#0B241C; --panel:#14352A; --panel-2:#1C4A3A; --line:#2C7658; --ink:#F2E8D5; --muted:#D2C2A0; --dim:#8A7F60; --accent:#A63F25; --accent-deep:#7A2E1A; --star:#E8C15A;',
    defaults: { name: 'Ida', age: '6', date: 'Sa, 17. Oktober', time: '15:00 Uhr', place: 'Sternenweg 7, Hamburg' } },
  meerjungfrau: { title: 'Meerjungfrau-Trailer', emoji: '🧜‍♀️', dur: 24,
    lede: 'Tauchgang zum Perlenpalast: 24 Sekunden Einladung, komplett auf deinem Gerät gerechnet, mit Ton. Tipp auf <b>MP4 erzeugen</b>, warte auf das Video und mach dann einen Screenshot vom Testprotokoll.',
    theme: '--ground:#0A2E3A; --panel:#0F4250; --panel-2:#155A6A; --line:#1F7A8C; --ink:#F2EAD6; --muted:#C9D3CC; --dim:#7F9A98; --accent:#E07A5F; --accent-deep:#B0432C; --star:#E9C46A;',
    defaults: { name: 'Ida', age: '6', date: 'Sa, 17. Oktober', time: '15:00 Uhr', place: 'Sternenweg 7, Hamburg' } },
  baustelle: { title: 'Baustellen-Trailer', emoji: '🚧', dur: 24,
    lede: 'Einsatz für die Party-Baustelle: 24 Sekunden Einladung, komplett auf deinem Gerät gerechnet, mit Ton. Tipp auf <b>MP4 erzeugen</b>, warte auf das Video und mach dann einen Screenshot vom Testprotokoll.',
    theme: '--ground:#1E2228; --panel:#2A3038; --panel-2:#343B45; --line:#4A5361; --ink:#F4F1E8; --muted:#C9C3B4; --dim:#8A8778; --accent:#D9700F; --accent-deep:#A85207; --star:#F6C21A;',
    defaults: { name: 'Ida', age: '6', date: 'Sa, 17. Oktober', time: '15:00 Uhr', place: 'Sternenweg 7, Hamburg' } },
  prinzessin: { title: 'Prinzessinnen-Trailer', emoji: '👑', dur: 24,
    lede: 'Die königliche Kutsche: 24 Sekunden Einladung, komplett auf deinem Gerät gerechnet, mit Ton. Tipp auf <b>MP4 erzeugen</b>, warte auf das Video und mach dann einen Screenshot vom Testprotokoll.',
    theme: '--ground:#2A1F3D; --panel:#3A2C52; --panel-2:#46366A; --line:#5E4C88; --ink:#FFF6EC; --muted:#D9CBE6; --dim:#9A8AB0; --accent:#D6336C; --accent-deep:#A61E4D; --star:#E9C46A;',
    defaults: { name: 'Ida', age: '6', date: 'Sa, 17. Oktober', time: '15:00 Uhr', place: 'Sternenweg 7, Hamburg' } },
  dschungel: { title: 'Dschungel-Trailer', emoji: '🌴', dur: 24,
    lede: 'Expedition zum Wasserfall: 24 Sekunden Einladung, komplett auf deinem Gerät gerechnet, mit Ton. Tipp auf <b>MP4 erzeugen</b>, warte auf das Video und mach dann einen Screenshot vom Testprotokoll.',
    theme: '--ground:#0F2A1A; --panel:#173D26; --panel-2:#1F4F31; --line:#2E7D32; --ink:#F3F0E4; --muted:#CFD8C4; --dim:#8AA08A; --accent:#C65D00; --accent-deep:#8E4300; --star:#FFD54F;',
    defaults: { name: 'Ida', age: '6', date: 'Sa, 17. Oktober', time: '15:00 Uhr', place: 'Sternenweg 7, Hamburg' } },
  detektiv: { title: 'Detektiv-Trailer', emoji: '🔎', dur: 24,
    lede: 'Akte eröffnet: 24 Sekunden Einladung, komplett auf deinem Gerät gerechnet, mit Ton. Tipp auf <b>MP4 erzeugen</b>, warte auf das Video und mach dann einen Screenshot vom Testprotokoll.',
    theme: '--ground:#10182F; --panel:#1B2A4A; --panel-2:#24365C; --line:#3A4F7A; --ink:#F4EFE4; --muted:#CFC9BC; --dim:#8A8A9A; --accent:#C62828; --accent-deep:#8E1B1B; --star:#FFD166;',
    defaults: { name: 'Ida', age: '6', date: 'Sa, 17. Oktober', time: '15:00 Uhr', place: 'Sternenweg 7, Hamburg' } },
