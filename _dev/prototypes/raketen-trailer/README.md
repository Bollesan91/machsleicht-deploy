...
Stand 16.09.2026. Acht von 15 Mottos laufen: **Weltraum** (`index.html`, 22 s), **Piraten** (`piraten.html`, 24 s),
...
(`prinzessin.html`, 24 s). Offen: Detektiv, Dschungel, Einhorn, Feen, Pferde, Safari, Superheld. Jede Seite rechnet aus
...
`STORY-meerjungfrau.md`, `STORY-baustelle.md`, `STORY-prinzessin.md`.
...
- `build/src/piraten.js`, `ritter.js`, `feuerwehr.js`, `dino.js`, `meerjungfrau.js`, `baustelle.js`, `prinzessin.js`
  — Drehbücher (Szenen, Figuren, Texte, Ton). Baustelle bringt einen Schaufelarm mit Zwei-Gelenk-IK (`armIK`, Posen als
  Winkel interpoliert) — Vorlage für weitere bewegliche Gliedmaßen. Prinzessin bringt eine fliegende Großfigur (Rosalie:
  Schweben, Aufsteigen, Rückkehr, Landung auf dem Turm) und Feuerwerk aus dem Hintergrundobjekt.
