...
const MOTTOS={
  ...
  items:['🌈','☁️','⭐','☁️','🌈','💫','☁️','🌈','⭐'],
  reward:'⭐', treasureFx:'🌈', emptyFx:'💨', stealFx:'😱', goal:'Regenbogen!',
  ...
  chaseHint:'Schnapp dir den Dalmatiner!',
  cine:{kick:'ALARM!', steal:'Ein frecher Dalmatiner schnappt sich den Orden!'},
  ...
  items:['🪨','🧱','🛢️','🪵','🚧','📦','🪨','🧱','🚧'],
  reward:'🔧', treasureFx:'🛠️', emptyFx:'💨', stealFx:'😱', goal:'Werkzeug!',
  sprite:'🦡', spriteName:'Frechdachs',
  sky:['#78909C','#FFB300','#F57F17','#263238'],
  hints:['Heb einen Brocken — halt gedrückt!','🔧 Werkzeug gefunden! Weiter buddeln!','Fast — wo steckt das letzte Werkzeug?'],
  chaseHint:'Schnapp dir den Frechdachs!',
  cine:{kick:'OH NEIN!', steal:'Ein Frechdachs schnappt sich das goldene Werkzeug!'},
  ...
  task:"Sammle die Dschungel-Früchte für {kid}!",
  items:['🌿','🍃','🪨','🌴','🍄','🌿','🪵','🍃','🌴'],
  reward:'🍍', treasureFx:'🍌', emptyFx:'💨', stealFx:'😱', goal:'Banane!',
  sprite:'🦧', spriteName:'Affe',
  sky:['#7CB342','#FFB74D','#FF7043','#1A237E'],
  hints:['Schieb das Blattwerk beiseite — halt gedrückt!','🍍 Frucht gefunden! Weiter durch den Dschungel!','Fast — wo versteckt sich der letzte Schatz?'],
  ...
  items:['🌸','🌼','🍄','🌺','🌿','🌷','🌸','🍄','🌼'],
  reward:'🌸', treasureFx:'🌺', emptyFx:'💨', stealFx:'😱', goal:'Blume!',
  sprite:'🧚', spriteName:'Fee',
  sky:['#F8BBD0','#CE93D8','#9C27B0','#1A0033'],
  hints:['Pust eine Blume an — halt gedrückt!','🌸 Zauberblume gefunden! Weiter sammeln!','Fast — wo blüht die letzte Zauberblume?'],
  chaseHint:'Fang die kleine Fee!',
  cine:{kick:'OH NEIN!', steal:'Eine kleine Fee schnappt sich die Zauberblume!'},
  win:{title:'Alle Zauberblumen blühen!', line:(k)=>\`Am Ende strahlt \${k} im Feenglanz — komm zur Feen-Party:\`,
  ...
  task:"Such die Leckerlis für {kid} im Stroh!",
  items:['🌾','🪣','🧺','🪵','🪨','🌾','🪣','🧺','🪵'],
  reward:'🥕', treasureFx:'🍎', emptyFx:'💨', stealFx:'😱', goal:'Apfel!',
  sprite:'🐴', spriteName:'Pony',
  sky:['#90CAF9','#FFCA28','#FF8A65','#311B92'],
  hints:['Wühl im Stroh — halt gedrückt!','🥕 Leckerli gefunden! Weiter suchen!','Fast — wo glänzt der letzte Schatz?'],
  chaseHint:'Fang das freche Pony!',
  cine:{kick:'OH NEIN!', steal:'Ein freches Pony schnappt sich den goldenen Apfel!'},
  win:{title:'Alle Ponys sind satt!', line:(k)=>\`Am Ende strahlt \${k} im Sattel — komm zum Reiterhof-Fest:\`,
  ...
  hints:['Durchsuch die Burg — halt gedrückt!','💎 Schatz gefunden! Weiter suchen!','Fast — wo liegt der letzte Schatz?'],
