...
const MOTTOS={
  ...
  cine:{kick:'OH-OH!', steal:'Das RIESEN-Ei wackelt … Krümel schlüpft — und flitzt mit dem Foto davon!'},
  ...
  photo:'/birthday-photo.jpg',
  icon:'📸',
  title:"Foto-Safari: Erwische alle Tiere!",
  ...
  sprite:'🐒', spriteName:'der freche Affe',
  ...
  chaseHint:'Der Affe hat die Kamera — schnapp ihn dir!',
  cine:{kick:'HUCH!', steal:'Ein frecher Affe schnappt die Kamera — und knipst wild drauflos!'},
  win:{title:'Alle im Kasten!', line:(k)=>\`Der freche Affe hat aus Versehen ein tolles Foto geknipst — und \${k} strahlt drauf! Komm zur Safari-Party:\`,
       lineNoFoto:(k)=>\`Alle Tiere im Kasten — \${k} lädt dich zur Safari-Party ein:\`},
  reveal:'🐒 Guck, was der Affe geknipst hat!',
  ...
  sprite:'🦝', spriteName:'der Törtchen-Dieb',
  ...
  chaseHint:'Schnapp dir den Törtchen-Dieb — er hat die Torte!',
  cine:{kick:'ERTAPPT!', steal:'Da rennt er! Der Törtchen-Dieb schnappt sich die Torte!'},
  win:{title:'Fall gelöst!', line:(k)=>\`Überführt! Der Törtchen-Dieb gibt die Torte zurück — und \${k} feiert weiter. Komm zur Detektiv-Party:\`,
  ...
  cine:{kick:'ALARM!', steal:'Doktor Grabsch schnappt sich deine letzte Superkraft!'},
  ...
  task:"Sammle die Juwelen für deine Krone, {kid}!",
  how:"👆 Heb ein Juwel — halt es gedrückt",
  items:['💎','🌹','🗝️','👠','🪞','🎀','💎','🦢','👑'],
  reward:['💎','💍','💎'], treasureFx:'👑', emptyFx:'✨', stealFx:'🐸', goal:'Deine Krone!',
  sprite:'🐸', spriteName:'der Kronen-Frosch',
  sky:['#F48FB1','#FFD54F','#9C27B0','#2E0854'],
  hints:['Sammle ein Juwel für deine Krone — halt gedrückt!','💎 Juwel gefunden! Deine Krone glitzert schon!','Fast — wo funkelt das letzte Juwel?'],
  chaseHint:'Fang den Frosch — er hat deine Krone!',
  cine:{kick:'PLOPP!', steal:'Ein Frosch schnappt sich deine Krone und hüpft davon!'},
  win:{title:'Du bist gekrönt!', line:(k)=>\`Der Frosch war ein verzauberter Prinz — und er krönt \${k}! Komm zur Krönungs-Party:\`,
  ...
  chaseHint:'Schnapp dir das UFO — es hat die Torte!',
  cine:{kick:'ALARM!', steal:'Ein UFO schnappt sich die Geburtstagstorte!'},
  ...
  items:['🌈','☁️','🌸','☁️','🌈','💫','☁️','🌈','⭐'],
  reward:['❤️','💛','💙'], treasureFx:'🌈', emptyFx:'☁️', stealFx:'🦄', goal:'Regenbogen!',
  ...
  sprite:'🧜‍♀️', spriteName:'die Meerjungfrau',
  ...
  chaseHint:'Schwimm ihr nach — fang die Meerjungfrau!',
  cine:{kick:'SCHWUPP!', steal:'In der letzten Muschel steckt die Meerjungfrau — und weg ist sie mit den Perlen!'},
  win:{title:'Die Perlenkette ist fertig!', line:(k)=>\`Die Meerjungfrau dreht sich um — und in der größten Perle strahlt \${k}! Komm zur Meerjungfrau-Party:\`,
  ...
  sprite:'🔥', spriteName:'der freche Funke',
  ...
  chaseHint:'Schnapp den frechen Funken — spritz ihn nass! 💦',
  cine:{kick:'ALARM!', steal:'Ein frecher Funke schnappt sich das letzte Kätzchen und tanzt davon — fang ihn!'},
  win:{title:'Alle gerettet!', line:(k)=>\`Der letzte Funke ist aus — \${k} hat alle Kätzchen gerettet! Rex bellt: Wau! Komm zur Feuerwehr-Party:\`,
       lineNoFoto:(k)=>\`Das Feuer ist aus — \${k} lädt dich zur Feuerwehr-Party ein:\`},
  reveal:'🐕 Rex bellt: Alle gerettet!',
  ...
  sprite:'🐦‍⬛', spriteName:'die Klau-Elster',
  ...
  chaseHint:'Schnapp die Klau-Elster, bevor sie wegfliegt!',
  cine:{kick:'OH NEIN!', steal:'Eine freche Elster schnappt sich den goldenen Bagger-Schlüssel und flattert davon!'},
  win:{title:'Bagger-Boss {kid}!', line:(k)=>\`Bagger Bruno hebt die Schaufel — und oben drauf strahlt \${k}! Komm zur Baustellen-Party:\`,
  ...
  sprite:'🧚', spriteName:'die Feenkönigin',
  ...
  chaseHint:'Fang die Feenkönigin — dann erfüllt sie deinen Wunsch!',
  cine:{kick:'HUSCH!', steal:'Die Feenkönigin schnappt sich das Feenlicht und flattert davon!'},
  win:{title:'Alle Feen leuchten für dich!', line:(k)=>\`Die Feenkönigin erfüllt einen Wunsch für \${k} — komm ins Feenlicht:\`,
  ...
  photo:'/birthday-photo.jpg',
  icon:'🐉',
  title:"Ritter {kid} und der Tortendrache",
  task:"Such die Schätze für {kid} — bevor der Drache die Geburtstagstorte klaut!",
  how:"👆 Durchsuch die Burg — halt gedrückt",
  items:['🗡️','🛡️','⛑️','🏹','🐴','🗝️','🔥','🥚','🍗'],
  reward:'🪙', treasureFx:'🎂', emptyFx:'💨', stealFx:'🐉', goal:'Torte!',
  sprite:'🐉', spriteName:'der Tortendrache',
  sky:['#42A5F5','#F57C00','#D32F2F','#0D1117'],
  hints:['Durchsuch die Burg — halt gedrückt!','🪙 Eine Goldmünze — mutig weiter!','Fast! Wo dampft die Geburtstagstorte?'],
  chaseHint:'Schnapp den Drachen — er hat die Torte!',
  cine:{kick:'OH NEIN!', steal:'Ein Drache schnappt sich die Geburtstagstorte!'},
  win:{title:'Der Drache feiert mit!', line:(k)=>\`Der Drache wollte nur ein Stück Torte — jetzt feiert er als neuer Freund mit! Komm zum Ritterfest, \${k}:\`,
       lineNoFoto:(k)=>\`Der Drache ist kein Feind mehr — \${k} lädt dich zum Ritterfest ein:\`},
