...
const MOTTOS={
  ...
  chaseHint:'Fang Ferdinand — er hat deine Krone!',
  cine:{kick:'PLOPP!', steal:'Frosch Ferdinand schnappt sich deine Krone und hüpft davon!'},
  ...
  photo:'/birthday-photo.jpg',
  icon:'🐚',
  title:"Fang Perla, die Meerjungfrau!",
  ...
  cine:{kick:'ALARM!', steal:'Das letzte Kätzchen Minka erschrickt und flitzt mitten ins Getümmel — schnell hinterher!'},
  ...
  cine:{kick:'OH NEIN!', steal:'Drache Fauchi schnappt sich die Geburtstagstorte!'},
  win:{title:'Der Drache feiert mit!', line:(k)=>\`Fauchi wollte nur ein Stück Torte — jetzt feiert er als neuer Freund mit! Komm zum Ritterfest, \${k}:\`,
