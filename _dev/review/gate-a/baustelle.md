...
- **Spielsand (25 kg Beutel)**
  > Nimm ausschließlich geprüften Spielsand ohne Schadstoffe — Bausand aus dem Baumarkt ist dafür nicht gemacht. Setz dich zu den Kleinsten an die Sandwanne und greif ein, sobald eine Hand mit Sand Richtung Mund geht.

- **Deko (Absperrband, Verkehrshütchen, Schild)**
  > Spann das Absperrband über Kopfhöhe oder klebe es flach an Wand und Möbel — meterlanges Band in Greifhöhe wickeln 3- bis 5-Jährige im Rollenspiel um Hals und Körper. Nach der Party rollst du es sofort auf.
...
- **Spielsand (50 kg)**
  > Kauf geprüften Spielsand, keinen Bausand aus dem Baumarkt — nur der ist für Kinderhände gedacht. An der Sandwanne bleibt eine erwachsene Person sitzen und greift ein, sobald Sand Richtung Mund wandert.

- **Deko (Absperrband + Verkehrshütchen + Schilder)**
  > Spann das Absperrband über Kopfhöhe oder klebe es flach an Wand und Möbel — meterlanges Band in Greifhöhe wickeln 3- bis 5-Jährige im Rollenspiel um Hals und Körper. Nach der Party rollst du es sofort auf.
...
- *Große Bauklötze + Mauer-Pappen* — Große Schaumstoff-Klötze (mind. 15 cm) und Papp-Bögen für Burg-Bauen und Maler-Station — keine Kleinteile, weicher Fall.
...
- **Spielsand (75 kg)**
  > Auch bei 75 kg gilt: geprüfter Spielsand, kein Bausand aus dem Baumarkt. Lass immer nur zwei bis drei Kinder gleichzeitig an die Wanne graben, setz dich mit dazu und greif ein, sobald eine Hand mit Sand Richtung Mund geht.

- **2-3 Mini-Schubkarren**
  > Belad die Schubkarre nur mit leichten Schaumstoff-Klötzen und steck eine kurze, gerade Strecke auf rutschfestem Boden ab — für Dreijährige reichen drei Meter. Es fährt immer nur ein Kind, im Gehtempo statt im Laufschritt, und bei den Kleinsten schiebst du mit.

- **Pinsel + Wasserfarben + Memory + Olympiade-Medaillen**
  > Medaillenbänder sind geschlossene Schlaufen: Schneid sie auf und knote sie locker mit einem einzelnen Knoten, der bei Zug aufgeht. Nach der Siegerehrung wird weitergetobt — dann kommt die Medaille ab. Kleine Medaillen prüfst du zusätzlich an der Klopapierrolle.

- **Deko-Wow (Absperrband + Verkehrshütchen + Schilder + Wand-Banner)**
  > Spann das Absperrband über Kopfhöhe oder klebe es flach an Wand und Möbel — meterlanges Band in Greifhöhe wickeln 3- bis 5-Jährige im Rollenspiel um Hals und Körper. Nach der Party rollst du es sofort auf.

- **Baustellen-Kuchen XL + Wow-Buffet**
...
- *Bauklötze XL + Mauer-Pappen + Wand-Deko* — Große Schaumstoff-Klötze (mind. 15 cm) plus Papp-Bögen für Burg, Maler-Station und Wand-Deko — keine Kleinteile, weicher Fall.
- *Diplome + Foto-Druck-Premium* — Papier-Urkunden und Fotos für die Diplom-Verleihung — kein Risiko-Material.
...
- **Plastik-Schrauben (25) + Werkzeug-Gürtel**
  > Prüf jede Schraube vor dem Verstecken mit einer leeren Klopapierrolle: Was komplett durchfällt, ist zu klein und bleibt in der Schachtel. Nimm nur die großen Plastik-Schrauben aus dem Set, keine echten Metallschrauben aus dem Werkzeugkasten.

- **Deko (Absperrband + Hütchen + Schilder)**
...
- *Lizenz-Hefte + Stempel + Urkunden* — Papier-Hefte, Urkunden und Kinder-Stempel für das Lizenz-System am Bauleiter-Tisch — kein Risiko-Material.
- *Werkzeug-Quiz-Karten (fertiges Kauf-Set — Alternative zu den gedruckten im Paket)* — Quiz-Karten für das Sitz-Spiel am Esstisch — reines Papier-/Kartenmaterial.
...
- **Plastik-Schrauben (30) + Werkzeug-Gürtel-Set**
  > Halt jede Schraube vor dem Verstecken an eine leere Klopapierrolle — was komplett durchrutscht, kommt weg. In den Werkzeug-Gürtel wandern nur die großen Plastik-Teile; echte Metallschrauben und Nägel räum vorher aus dem Spielbereich.

- **Deko (Absperrband + Hütchen + Schilder + Foto-Box)**
  > Spann das Band über Kopfhöhe und nie quer über Laufwege — in Kopf- und Halshöhe gespannt ist es beim Rennen eine Falle, in Greifhöhe wird es zum Wickeln benutzt. Nach der Party kommt es sofort ab.

- **Bauarbeiter-Kuchen + Buffet Standard**
...
- *Lizenz-Hefte + Stempel + Urkunden* — Papier-Hefte, Urkunden und Kinder-Stempel für das Lizenz-System — kein Risiko-Material.
- *Werkzeug-Quiz-Karten (fertiges Kauf-Set — Alternative zu den gedruckten im Paket) + Bauplan-Karten* — Quiz- und Bauplan-Karten für Sitz-Stationen am Tisch — reines Papier-/Kartenmaterial.
...
- **Plastik-Schrauben (40) + Werkzeug-Gürtel-Premium**
  > Auch bei 40 Stück gilt der Klopapierrollen-Test: Was komplett durch die Rolle fällt, kommt nicht ins Versteck. Verwende nur die großen Plastik-Schrauben des Sets und zähl sie nach der Schatzsuche einmal durch.

- **3 Mini-Schubkarren**
  > Markier die Strecke mit Klebeband auf höchstens 10 Meter und such rutschfesten Boden — Rasen oder Teppich statt glatter Fliesen. Es fährt immer nur ein Team, und zwar im Gehtempo: Stopp die Runde, sobald jemand losrennt.

- **Deko-Wow + LED-Warnlampen + Foto-Box-Premium**
...
- *Lizenz-Hefte + Stempel + Pokale + Urkunden Klasse 1+2* — Papier-Hefte, Urkunden, Kinder-Stempel und Pokale für Lizenz-System und Olympiade — keine Nadeln, kein Risiko-Material.
- *Werkzeug-Quiz-Kaufset Großversion (Alternative zu den 12 gedruckten) + Bauplan-Karten XL* — Quiz- und Bauplan-Karten für Sitz-Stationen am Tisch — reines Papier-/Kartenmaterial.
- *Spielsand (60 kg)* — DIN-geprüfter Spielsand für die Sand-Schatzsuche XL bei 6-8 — ungiftig, kein Ess-Alter mehr.
- *Acrylfarben Premium + Pinsel + Pappkarton XL* — Abwaschbare (washable) Farben mit Pinseln und Schürzen am beaufsichtigten Maltisch der Maler-Station für 6-8 — ungiftiges Bastelmaterial.
- *Bauarbeiter-Kuchen XL + Wow-Buffet* — Buffet für 6-8-Jährige außerhalb des Aspirations-Alters; Allergie-Abfrage-Regel (inkl. Marzipan=Mandel-Hinweis) existiert bereits in parentTips und Vorbereitungsplan.
...
- **Prüfungs-Mappen + Funktions-Karten + Diplome + Bauleiter-Pokal**
  > Die Pins haben eine offene Nadel: Du steckst sie an, nicht die Kinder — und zwar an Weste oder Mappe, nicht auf Brusthöhe der Haut. Verschluss jedes Mal zudrücken; sind jüngere Geschwister im Haus, bleiben die Pins bis zum Abschied in der Schachtel.

- **Bauklötze (120 Stk Premium)**
  > Klötze werden gestapelt und weitergereicht, nie geworfen — sag das vor dem Start einmal laut. Stell die Bauplätze einen Meter auseinander und schick alle, die gerade nicht selbst bauen, aus diesem Meter heraus, solange ein hoher Turm steht.

- **Werkzeug-Gürtel + kindgerechtes Werkzeug-Set (Plastik-Schraubenzieher, Holz-Schrauben, Maßband)**
...
- **Bauarbeiter-Kuchen + Pizza + Buffet**
...
- *Optional: Werkzeug-Quiz-Kaufset Klasse 2 (Alternative zu den 25 gedruckten)* — Quiz-Karten für das Sitz-Spiel am Tisch — reines Kartenmaterial.
...
- **Bauleiter-System Komplett**
  > Die Pins haben eine offene Nadel: Du steckst sie an, nicht die Kinder — und zwar an Weste oder Mappe, nicht auf Brusthöhe der Haut. Verschluss jedes Mal zudrücken; sind jüngere Geschwister im Haus, bleiben die Pins bis zum Abschied in der Schachtel.

- **Bauklötze (150 Premium) + Materialien für Material-Erkennung**
  > In die Fühl-Beutel kommt nur, was du vorher abgetastet hast: Metallschrauben ohne Grat, Ziegel- und Betonstücke glatt geschliffen, keine scharfen Bruchkanten. Blind hineingreifen heißt, dass niemand die Kante kommen sieht.

- **Werkzeug-Gürtel + echtes Werkzeug-Premium-Set (10)**
...
- **Baustellen-Kuchen + Pizza-XL + Buffet**
  > Stockbrot heißt offene Flamme: Nur ein Erwachsener am Feuer, ein Kind nach dem anderen, zwei Meter Abstand für die Wartenden und ein Eimer Wasser daneben. Die Stöcke sind vorne spitz — sie bleiben am Feuer und wandern nicht mit an den Tisch. Roher Teig wird nicht genascht.
...
- *Optional: Werkzeug-Quiz-Kaufset XL (Alternative zu den 25 gedruckten Karten)* — Quiz-Karten für das Sitz-Spiel am Tisch — reines Kartenmaterial.
...
- **Bauleiter-System Wow (Diplom Kl 2 + Pokale + Pins + Bauleiter-Pokal + Brücken-Pokal)**
...
- **Bauklötze (200 Premium) + Brücken-Bau-Set + Material-Erkennung-Beutel**
  > In die Fühl-Beutel kommt nur, was du vorher abgetastet hast: Metallschrauben ohne Grat, Ziegel- und Betonstücke glatt geschliffen, keine scharfen Bruchkanten. Blind hineingreifen heißt, dass niemand die Kante kommen sieht.

- **Werkzeug-Gürtel Premium + echtes Werkzeug Wow-Set + Maßband + Wasserwaage**
  > Echtes Werkzeug nur unter Aufsicht einer erwachsenen Person, immer nur ein Kind pro Werkzeug. Keine scharfen Metall-Schrauben mit Spitzen. Nach jeder Station einsammeln und zählen.

- **3 Mini-Schubkarren**
  > Steck die Schubkarren-Strecke auf höchstens 10 Meter ab und wähl weichen, rutschfesten Boden. Es fährt immer nur ein Team gleichzeitig — markier eine Startlinie mit Klebeband und schick die Wartenden dahinter.

- **Brücken-Last-Test-Set (Sandsäckchen 50/100/200g)**
  > Setz die Sandsäckchen einzeln mit der Hand auf die Brücke und lass sie nie fallen. Zieh danach Hand und Gesicht einen Meter zurück, bevor das nächste Gewicht draufkommt, und halt die Zuschauer im selben Abstand.

- **Deko-Wow + LED-Warnlampen + Stroboskop + Foto-Bereich**
  > Frag vor dem Einsatz bei allen Eltern nach Epilepsie und Lichtempfindlichkeit — Blitzlicht kann Anfälle auslösen. Im Zweifel lässt du das Stroboskop aus; eine Disco-Lampe mit langsamem Farbwechsel macht dieselbe Stimmung ohne das Risiko.

- **Baustellen-Kuchen XXL + Pizza-Lieferung + Wow-Buffet**
  > Stockbrot heißt offene Flamme: Nur ein Erwachsener am Feuer, ein Kind nach dem anderen, zwei Meter Abstand für die Wartenden, Wassereimer daneben, und die spitzen Stöcke bleiben am Feuer. Die Marzipan-Figuren im Kuchen bestehen aus Mandeln — Nussallergie mit der Einladung abfragen.

- **Optional: Mini-Baustellen-Besuch mit Schutzbekleidung (1h, geführt)**
...
- *Optional: Werkzeug-Quiz-Kaufset XXL (Alternative zu den 25 gedruckten + Bonus-Fragen)* — Quiz-Karten für das Sitz-Spiel am Tisch — reines Kartenmaterial.
- *Bauplan-Material Wow + Skizzen-Heft + Profi-Beispiele* — Zeichenmaterial und Hefte am Tisch der Bauplan-Werkstatt — Schulmaterial-Niveau für 9-12.
