...
- **Zutaten Kastenkuchen (Mehl, Butter, Eier, Zucker)**
  > Die Holzspieße der Segelmasten ziehst du heraus, bevor der Kuchen auf den Tisch kommt — ein Spieß im Kuchenstück ist bei 3- bis 5-Jährigen eine Stichverletzung im Mund. Zähl sie beim Abräumen nach, sie verschwinden gern unter Servietten.

- **Piratenhüte oder Bandanas (6er-Set)**
  > Bandanas werden auf dem Kopf getragen, nie um den Hals gebunden — beim Toben wird aus dem Knoten am Hals eine Schlinge. Wer sein Tuch abnimmt, legt es auf den Stuhl, nicht um die Schultern.

- **Spielzeug-Kompass**
  > Prüf den Kompass vor der Party: Billige Gehäuse springen beim Fallen auf, und dann liegt eine kleine Magnetnadel frei — verschluckte Magnete ziehen sich im Darm an und sind ein chirurgischer Notfall. Ein gesprungenes Gehäuse kommt sofort weg.

- **Dickes Seil / Springseil**
...
- **Papier für Schatzkarten + Stempel-Set**
  > Halt jedes Teil des Stempel-Sets vorher an eine Klopapierrolle — was durchpasst, kann in diesem Alter im Hals stecken bleiben. Gib kleine Stempel und Deckel einzeln aus, gebastelt wird sitzend am Tisch, und danach sammelst du alles wieder ein.

- **Mitgebsel-Kleinkram (Mini-Spielzeug)**
  > Halt jedes Mini-Spielzeug an eine Klopapierrolle: Was durchpasst, ist bei 3- bis 5-Jährigen Erstickungsgefahr und bleibt in der Schachtel. Achte auf abtrennbare Räder und Figuren — die Tüte wird zuhause ohne Aufsicht geöffnet.
...
- **Bastel-Set Schatzkarten (Stempel, Papier, Stifte)**
  > Halt jedes Teil aus dem Set an eine Klopapierrolle, bevor die Kinder es bekommen — was durchpasst, ist bei Dreijährigen Erstickungsgefahr. Kleine Stempel und Deckel gibst du einzeln aus und sammelst sie nach der Station wieder ein.

- **Piratenflaggen + Deko-Set**
  > Girlanden und Deko-Schnüre hängst du außer Greifhöhe auf — im Deko-Set stecken meist auch Luftballons: Aufgepustet wird von dir, geplatzte Fetzen und ungeblasene Ballons sammelst du sofort ein, weil Kleinkinder daran am häufigsten ersticken.
...
- *Schatzkisten-Urkunde (Druckvorlage/Block)* — Gedruckte Papier-Urkunde als Abschieds-Andenken — kein Risiko.
- *Apfelschorle / Saft für 'Piraten-Grog'* — Kaltes Getränk am Tisch in Bechern — kein Risiko.
- *Tonkarton / Goldfolie für Schatzkiste* — Wird von den Eltern vorab zur Schatzkiste (und 'Meer'-Platte) verbastelt — kein loses Material in Kinderhand.
- *Piraten-Servietten + Pappteller* — Tischdeko und Essgeschirr am gedeckten Tisch — kein Risiko.
- *Holz-Schatzkiste (statt Schuhkarton)* — Requisit, das versteckt und am Ende gemeinsam unter Erwachsenen-Aufsicht geöffnet wird — kein relevantes Risiko.
...
- **Kuchen + Getränke + Snacks**
  > Die Zahnstocher-Segel ziehst du heraus, bevor der Kuchen verteilt wird, und Obst-Spieße streifst du vom Holz — mit dem Spieß im Mund wird zwischen den Stationen gerannt. Popcorn bleibt am Tisch: Für mitfeiernde Geschwister unter vier ist es ein Aspirationsrisiko.
...
- **Zahlenschloss 3-stellig**
  > Nimm ein leichtes Zahlen-Fahrradschloss statt eines Vorhängeschlosses — ein Bügel aus Metall springt beim Öffnen auf und fällt gern auf Finger. Häng es locker durch den Truhendeckel und stell die Truhe zum Knacken flach hin.

- **Seile (Knotenkunde)**
  > Geknotet wird an Stuhlbein, Stange oder Ring — nie um Hals, Handgelenk oder Fußgelenk eines Kindes, auch nicht im Spaß. Nach der Knotenkunde sammelst du die Seile ein, bevor das nächste Tobespiel losgeht.

- **Kuchen + Essen + Getränke**
  > Die Zahnstocher-Segel ziehst du heraus, bevor der Kuchen verteilt wird, und Obst-Spieße streifst du vom Holz — mit dem Spieß im Mund wird zwischen den Stationen gerannt. Popcorn bleibt am Tisch: Für mitfeiernde Geschwister unter vier ist es ein Aspirationsrisiko.
...
- **Piraten-Tattoos**
  > Klebe-Tattoos testest du erst an einer kleinen Stelle am Unterarm und fragst mit der Einladung nach empfindlicher Haut — sie kommen auf den Handrücken, nicht ins Gesicht. Beim ersten Jucken mit Öl ablösen.

- **Seile für Knotenkunde**
  > Geknotet wird an Stuhlbein, Stange oder Ring — nie um Hals, Handgelenk oder Fußgelenk eines Kindes, auch nicht im Spaß. Nach der Knotenkunde sammelst du die Seile ein, bevor das nächste Tobespiel losgeht.
...
- *Fernrohre 6 Stk.* — Kunststoff-Spielzeugfernrohre als Requisit und Mitgebsel für 6-8-Jährige — kein Risiko.
...
- **Seil/Kordel-Rolle für die Knoten-Prüfung**
...
- **Mini-Kompass-Anhänger als Mitgebsel (Set)**
...
- *Schatztruhe-Vorlage (Schuhkarton + Goldfolie) oder günstige Mini-Truhe* — Von Erwachsenen gebasteltes bzw. gekauftes Requisit als Ziel der Schatzsuche für 9-12-Jährige — kein Risiko.
...
- **Walkie-Talkies für den Crew-Funk**
...
- *Umschläge + Siegel-Aufkleber für die Codeknacker-Station* — Papier-Umschläge mit Aufkleber-Siegeln, die 9-12-Jährige an der Rätsel-Station öffnen — kein Risiko.
- *Schatztruhe + Mitgebsel-Inhalt für 8–10* — Truhen-Requisit mit Beute, die am Ende an 9-12-Jährige verteilt wird — in dieser Altersgruppe kein Kleinteil-Risiko (der enthaltene Mini-Kompass ist über das Anhänger-Urteil bzw. dessen Note abgedeckt).
- *Spielzeug-Kompass (1 pro Crew, 3 Stück)* — Arbeits-Requisit an der Navigations-Station in der Hand von 9-12-Jährigen — kein Verschluck-Kontext in dieser Altersgruppe.
- *Spezialisierungs-Patches (Navigator/Quartiermeister/Spurenleser)* — Aufkleber/Patches für die Crew-Karten von 9-12-Jährigen — kein Risiko.
...
- *Große Schatztruhe + Mitgebsel-Inhalt für 8–12* — Truhen-Requisit mit Beute für 9-12-Jährige am Quest-Ende — in dieser Altersgruppe kein Kleinteil-Risiko.
- *Spielzeug-Kompasse (1 pro Crew)* — Arbeits-Requisit für Navigator-Station und Nordstern-Posten in der Hand von 9-12-Jährigen — kein Verschluck-Kontext in dieser Altersgruppe.
- *Spezialisierungs-Patches + reflektierende Hinweis-Sticker* — Aufkleber und Reflektor-Sticker für Crew-Karten und Nacht-Route, verarbeitet von Erwachsenen und 9-12-Jährigen — kein Risiko.
- *Aufblasbares Piraten-Schiff (Pinterest-Maximum)* — Reines Deko-/Foto-Requisit ohne Spiel- oder Wasser-Einsatz (laut categoryReasoning explizit kein Spiel-Element) — kein Regelbedarf bei 9-12.
