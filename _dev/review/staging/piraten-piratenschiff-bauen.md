...
## Material
- 2–3 große Umzugskartons (kostenlos aus Umzügen/Supermarkt), Kreppband/Paketband.
- Buntstifte/Wachsmalstifte/abwaschbare Farbe + Pinsel, altes Bettlaken (Segel), Pappreste (Steuerrad/Flagge), schwarzer Stift/Tonpapier (Jolly Roger).
- **Eltern-Werkzeug:** Schere/Cutter NUR für Erwachsene (Bullaugen/Schlitze vorschneiden).
...
Zwei Teams, gleiches Material, 20 Min: wer baut das coolste/stabilste Schiff? Jury (Erwachsene + Geburtstagskind) wertet Stabilität, Design, Teamwork — **kein Verlierer, beide Schiffe bleiben Kulisse**, jedes Team kriegt einen „Werft-Orden".

## Sicherheit
**Schneiden/Cutter ausschließlich durch Erwachsene** — Kinder kleben/malen/bauen nur. Schnittkanten der Kartons innen umkleben (keine scharfen Ränder/Heftklammern offen). Abwaschbare/lösungsmittelfreie Farben. Begehbares Schiff: nicht draufklettern/-stehen (Karton trägt nicht) — es ist Kulisse, kein Klettergerüst; das vorab ansagen. Genug Platz, Stolperfallen (Bänder) sichern.
