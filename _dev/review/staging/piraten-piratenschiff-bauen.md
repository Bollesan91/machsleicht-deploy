...
## Quickstart
Aus 2–3 großen Umzugskartons baut die Crew gemeinsam ein begehbares Piratenschiff: Bullaugen, Segel aus einem Bettlaken, Steuerrad aus Pappe, Flagge. **Jedes Kind hat eine echte Bau-Aufgabe** (Wände bemalen, Bullaugen einkleben, Steuerrad bauen, Flagge gestalten, Namen ausdenken). Am Ende: **Crew-Foto auf dem fertigen Schiff** — und das Schiff bleibt Kulisse/Basis für die nächsten Spiele.
...
## Variante 9–12 „Konstruktions-Wettbewerb"
Zwei Teams, gleiches Material, 20 Min: wer baut das coolste/stabilste Schiff? Jury (Erwachsene + Geburtstagskind) wertet Stabilität, Design, Teamwork — **kein Verlierer, beide Schiffe bleiben Kulisse**, jedes Team kriegt einen „Werft-Orden". (Nur mit zweitem Erwachsenen fürs zweite Team-Schneiden.)

## Sicherheit
**Schneiden/Cutter ausschließlich durch Erwachsene** — Kinder kleben/malen/tapen/bauen nur. Schnittkanten der Kartons innen umkleben (keine scharfen Ränder/Heftklammern offen). Abwaschbare/lösungsmittelfreie Farben. **Kein Heißkleber** (Paketband reicht überall — kein Verbrennungsrisiko). Begehbares Schiff: nicht draufklettern/-stehen (Karton trägt nicht) — es ist Kulisse, kein Klettergerüst; das vorab ansagen. Genug Platz, Stolperfallen (Bänder) sichern.

## Aufräumen / danach
Farben vorher auf abwaschbar prüfen (Tisch/Boden mit alter Decke/Folie schützen). Das Schiff bleibt erst Kulisse für die Folge-Spiele; danach lässt es sich flach zusammenfalten (Paketband lösen) und kommt in die Papiertonne — vorab kurz einplanen, besonders in der Wohnung.

## Inklusion
Viele Stationen → jedes Kind findet eine aktive Aufgabe (malen, kleben, tapen, Namen erfinden, Segel halten). Kind mit Einschränkung: Sitz-Aufgaben mit echtem Output (Steuerrad bemalen, Flagge designen, Schiffsname). Kein Tempo, kein Rauswurf, kein „falsch". Geschlechtsneutral.

## Gruppengröße
Ideal **4–8 an einem Schiff** (genug Stationen, kein Gedränge). **>8:** entweder **zwei parallele Bau-Teams** (braucht zweiten Erwachsenen fürs Schneiden) ODER **ein größeres Schiff mit mehr Stationen** (zwei Maler-Crews vorne/hinten, eigene Deko-Crew) — durch die feste Stationen-Aufteilung bleibt auch bei 10–12 jedes Kind beschäftigt, niemand wartet. Solo/2 geht (kleineres Schiff), lebt aber vom Team.
