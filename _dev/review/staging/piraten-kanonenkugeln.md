...
**Name:** Kanonenkugeln
**Einzeiler:** Feindliche Schiffe versenken — wirf die Kanonenkugeln in die Fässer; je weiter das Ziel, desto mehr Beute.
**Getaggte Alter:** 3–5, 6–8, 9–12 (bestAge 6–8)
**Typ:** aktiv / Geschick-Wettkampf
**Spieleranzahl:** min. 1, ideal 4–10, solo-fähig
**Dauer:** 8–12 Min · **Eltern-Vorbereitung:** 5 Min · **Abbau:** 3 Min · **Indoor + Outdoor**
**Platzbedarf:** min. ~3 m Tiefe × 4 m Breite; seitlich ~2 m frei zu Fenstern/Regalen/Deko.
...
- Punkte-Tafel/Zettel + Stift. Stempel + hautfreundliches Stempelkissen ODER Crew-Aufkleber. Belohnung ab 6 J: Schoko-Goldmünzen nach dem Spiel.

## Anleitung (Basis 6–8)
0. Optional (10 Sek): „Feindschiffe voraus — Kanonen laden, Kanonier:innen!"
1. 3 Ziel-Eimer (mit Totenkopf-Tuch) in 2 / 3 / 4 m aufstellen, Wurflinie + Hütchen kleben.
2. Jedes Kind bekommt 5 Kanonenkugeln und stellt sich hinter die Wurflinie.
3. Reihum (oder an parallelen Stationen) werfen — nur auf die Schiffe. Naher Eimer = 1 Punkt, mittlerer = 2, ferner = 3. Jedes Kind wirft pro Runde alle 5 Kugeln; je nach Zeit 2–3 Runden.
