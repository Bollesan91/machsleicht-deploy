...
Self-Assessment: Alle 6 Reviewer-Punkte umgesetzt — Längen-Fixes durchgezogen (alle steps jetzt ≤120 Zeichen), regen-Headline mit explizitem „Wache verlegen / Einsatz-Zentrale"-Frame, weniger_kinder-Fallback auf echten Krisen-Fallback umgestellt, kuchen step 4 entdramatisiert + Headline auf realistische 15 Min korrigiert, ein_kind_weint Heimweh-Reframe mit Wahl-Option statt Default-Anruf, und mehr_kinder auf 4 steps normalisiert. Bewusst beibehalten: ein_kind_weint step 5 mit 113 Zeichen — der Reviewer-Vorschlag „nicht fragen, einfach mitnehmen" trennt die Anweisung von der Begründung sauberer, das ist die bessere Version. Score-Estimat: ~92.