...
pb = json.load(io.open('_dev/content-loop/runs/10-safari-mittel-phase-b/_safari_mittel_phase_b.json', encoding='utf-8'))
...
fw = json.load(io.open('_src/elite-motto-data/safari-mittel.json', encoding='utf-8'))
...
with io.open('_src/elite-motto-data/safari-mittel.json', 'w', encoding='utf-8') as f:
