...
pb = json.load(io.open('_dev/content-loop/runs/07-feuerwehr-gross-phase-b/_feuerwehr_gross_phase_b.json', encoding='utf-8'))
...
fw = json.load(io.open('_src/elite-motto-data/feuerwehr-gross.json', encoding='utf-8'))
...
fw['_meta']['phase_b_method'] = 'Direct draft — gross-spezifika (3-4h, Eltern absetzen, echter Wettbewerb, Escape-Room-Brandermittlung) durchgehend angewandt.'

with io.open('_src/elite-motto-data/feuerwehr-gross.json', 'w', encoding='utf-8') as f:
