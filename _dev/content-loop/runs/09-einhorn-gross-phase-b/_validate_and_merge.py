...
pb = json.load(io.open('_dev/content-loop/runs/09-einhorn-gross-phase-b/_einhorn_gross_phase_b.json', encoding='utf-8'))
...
fw = json.load(io.open('_src/elite-motto-data/einhorn-gross.json', encoding='utf-8'))
...
fw['_meta']['phase_b_method'] = 'Direct draft — einhorn-gross-spezifika (3-4h, Eltern absetzen, Code-Names, Chemie-Labor, Schmuck-Workshop, Mirror-Glaze-Galaxy-Kuchen) durchgehend angewandt.'

with io.open('_src/elite-motto-data/einhorn-gross.json', 'w', encoding='utf-8') as f:
