...
pb = json.load(io.open('_dev/content-loop/runs/08-einhorn-klein-phase-b/_einhorn_klein_phase_b.json', encoding='utf-8'))
...
fw = json.load(io.open('_src/elite-motto-data/einhorn-klein.json', encoding='utf-8'))
...
fw['_meta']['phase_b_method'] = 'Direct draft — einhorn-klein-spezifika (1,5-2h, Eltern-Pflicht, Glitzer-Allergie-Test, kein Fondant) durchgehend angewandt.'

with io.open('_src/elite-motto-data/einhorn-klein.json', 'w', encoding='utf-8') as f:
