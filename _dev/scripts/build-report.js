    ...
    children: [
      ...
      new Table({
        ...
        rows: [
          ...
          new TableRow({ children: [cell("Affiliate-Links (42 St\u00FCck)", 3600, { bold: true, color: C.green }), statusCell("NEU", 1000), cell("Amazon-URLs mit tag=machsleicht-21 auf allen Deko/Mitgebsel + \u201EAmazon \u2197\u201C Button.", 4426, { fill: C.greenBg })] }),
      ...
      new Table({
        ...
        rows: [
          ...
          new TableRow({ children: [cell("Affiliate-Links", 3000, { bold: true }), cell("\u20AC0 \u2192 Revenue", 1500, { color: C.green }), cell("42 Amazon-Links mit machsleicht-21 Tag auf allen Kaufen-Items. \u201EAmazon \u2197\u201C Button in jeder Zeile.", 4526)] }),
