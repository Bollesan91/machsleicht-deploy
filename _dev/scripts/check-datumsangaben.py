...
# "Sa, 21.06.2026" / "Samstag, 21.6.2026" / "Sa. 21.06.2026" / "Sa 21.06.2026"
MIT_WOCHENTAG = re.compile(
    r"\b(" + "|".join(sorted(WOCHENTAGE, key=len, reverse=True)) + r")\b[.,]?\s+"
