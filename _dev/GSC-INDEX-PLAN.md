...
5. Klick "**Indexierung beantragen**"
6. Warten (~1-2 Min "Live-URL testen abgeschlossen")
7. Bestätigen → Häkchen am unten in die Tabelle setzen

---

## ✅ Tag 1 — Do 22.05.2026 (heute, erledigt)

Tier 1+2 abgeschlossen (Tageskontingent erschöpft).

- [x] `https://machsleicht.de/sitemap.xml` (Sitemap einreichen)
- [x] `https://machsleicht.de/kindergeburtstag`
- [x] `https://machsleicht.de/schatzsuche`
- [x] `https://machsleicht.de/einladung`
- [x] `https://machsleicht.de/kindergeburtstag/safari-9-12-jahre`
- [x] `https://machsleicht.de/kindergeburtstag/safari-3-5-jahre`
- [x] `https://machsleicht.de/kindergeburtstag/safari-6-8-jahre`

*(Häkchen ggf. nachjustieren — alles was du heute geschafft hast.)*

---

## ⏰ Tag 2 — Fr 23.05.2026 — Long-Tail SEO-Stars

- [ ] `https://machsleicht.de/kindergeburtstag-spiele-draussen` (2693W)
- [ ] `https://machsleicht.de/kindergeburtstag-spiele-drinnen` (2457W)
- [ ] `https://machsleicht.de/kindergeburtstag-checkliste` (2554W)
- [ ] `https://machsleicht.de/kindergeburtstag-zeitplan` (2524W)
- [ ] `https://machsleicht.de/kindergeburtstag-drinnen` (3330W)
- [ ] `https://machsleicht.de/kindergeburtstag-draussen` (2342W)
- [ ] `https://machsleicht.de/kindergeburtstag-7-jahre` (3047W)
- [ ] `https://machsleicht.de/kindergeburtstag-last-minute` (1904W)
- [ ] `https://machsleicht.de/kindergeburtstag-zuhause` (1794W)
- [ ] `https://machsleicht.de/kindergeburtstag-bei-regen` (1937W)

---

## ⏰ Tag 3 — Sa 24.05.2026 — Einhorn-Tier + Content-Pages

- [ ] `https://machsleicht.de/kindergeburtstag/einhorn-9-12-jahre` (5320W)
- [ ] `https://machsleicht.de/kindergeburtstag/einhorn-3-5-jahre` (4813W)
- [ ] `https://machsleicht.de/kindergeburtstag/einhorn-6-8-jahre` (4641W)
- [ ] `https://machsleicht.de/kindergeburtstag-einladung-text` (2467W)
- [ ] `https://machsleicht.de/kindergeburtstag-essen` (2239W)
- [ ] `https://machsleicht.de/kindergeburtstag-torte-einfach` (2563W)
- [ ] `https://machsleicht.de/kindergeburtstag-wenig-aufwand` (2082W)
- [ ] `https://machsleicht.de/kindergeburtstag-kosten` (2363W)
- [ ] `https://machsleicht.de/kindergeburtstag-mitgebsel` (1963W)
- [ ] `https://machsleicht.de/kindergeburtstag-5-jahre` (2373W)

---

## ⏰ Tag 4 — So 25.05.2026 — Motto-Hubs (alle 9)

- [ ] `https://machsleicht.de/kindergeburtstag/safari`
- [ ] `https://machsleicht.de/kindergeburtstag/feuerwehr`
- [ ] `https://machsleicht.de/kindergeburtstag/einhorn`
- [ ] `https://machsleicht.de/kindergeburtstag/piraten`
- [ ] `https://machsleicht.de/kindergeburtstag/dino`
- [ ] `https://machsleicht.de/kindergeburtstag/weltraum`
- [ ] `https://machsleicht.de/kindergeburtstag/detektiv`
- [ ] `https://machsleicht.de/kindergeburtstag/prinzessin`
- [ ] `https://machsleicht.de/kindergeburtstag/superheld`
...
## ⏰ Tag 5 — Mo 26.05.2026 — Dino + Piraten + Schatzsuche

- [ ] `https://machsleicht.de/kindergeburtstag/dino-6-8-jahre` (3465W)
- [ ] `https://machsleicht.de/kindergeburtstag/dino-3-5-jahre` (3216W)
- [ ] `https://machsleicht.de/kindergeburtstag/dino-9-12-jahre` (2973W)
- [ ] `https://machsleicht.de/kindergeburtstag/piraten-6-8-jahre` (2489W)
- [ ] `https://machsleicht.de/schatzsuche/piraten`
- [ ] `https://machsleicht.de/schatzsuche/detektiv`
- [ ] `https://machsleicht.de/schatzsuche/safari`
- [ ] `https://machsleicht.de/schatzsuche/einhorn`
- [ ] `https://machsleicht.de/schatzsuche/dino`
- [ ] `https://machsleicht.de/schatzsuche/weltraum`

---

## ⏰ Tag 6 — Di 27.05.2026 — Einladung + Sonstige

- [ ] `https://machsleicht.de/schatzsuche/feen`
- [ ] `https://machsleicht.de/schatzsuche/dschungel`
- [ ] `https://machsleicht.de/schatzsuche/feuerwehr`
- [ ] `https://machsleicht.de/einladung/piraten` (5152W)
- [ ] `https://machsleicht.de/einladung/dino` (4902W)
- [ ] `https://machsleicht.de/einladung/einhorn`
- [ ] `https://machsleicht.de/einladung/safari`
- [ ] `https://machsleicht.de/einladung/feuerwehr`
- [ ] `https://machsleicht.de/kindergeburtstag-6-jahre` (2216W)
- [ ] `https://machsleicht.de/baby`

---

## ⏰ Tag 7 — Mi 28.05.2026 — Re-Check + Rest-Pages

Erst in GSC checken: welche der bisherigen Anfragen sind nach 5-6 Tagen tatsächlich indexiert?
Bei "Gecrawlt – nicht indexiert" → nochmal beantragen (manchmal hilft Re-Trigger).

Plus restliche Pages:
- [ ] `https://machsleicht.de/einladung/detektiv`
- [ ] `https://machsleicht.de/einladung/weltraum`
- [ ] `https://machsleicht.de/einladung/superheld`
- [ ] `https://machsleicht.de/einladung/prinzessin`
- [ ] `https://machsleicht.de/einladung/erstellen`
- [ ] `https://machsleicht.de/einschulung` (wenn überarbeitet, sonst überspringen)
- [ ] `https://machsleicht.de/kreuzwortraetsel`
- [ ] `https://machsleicht.de/spielkarten`
- [ ] `https://machsleicht.de/kindergeburtstag-8-jahre`
- [ ] `https://machsleicht.de/kindergeburtstag-9-jahre`

---

## 📊 Nach 7 Tagen: Reality-Check

In GSC nachsehen:
- **Wie viele der 60 angefragten URLs sind in "Indexiert"?**
- **Welche bleiben in "Gecrawlt – nicht indexiert"?** → diese brauchen externe Backlinks (Pinterest, Reddit, GuteFrage)
- **Erste organische Besucher?** (Plausible/Umami)

Wenn Indexierungs-Quote < 20% nach 7 Tagen: das Problem ist nicht GSC-Aufmerksamkeit sondern fehlende externe Authority. Backlink-Sprint priorisieren.
...
- **Tageskontingent nicht ausreizen** — manchmal lässt GSC nur 8 statt 12 zu. Wenn limit kommt: morgen weitermachen, nicht erzwingen.
- **Reihenfolge nach Score** — wenn Limit früh kommt, sind die wichtigsten URLs schon durch.
- **Sitemap nur 1× einreichen** — Google crawlt sie automatisch alle paar Tage.
- **URL-Prüfung auch ohne "Indexierung beantragen"** zeigt dir, ob Google die Page bereits kennt, ob sie crawlbar ist, ob Canonical/Robots stimmt — gute Debugging-Quelle.
