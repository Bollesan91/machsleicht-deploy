...
- #4 spuren-safari (Story-Nachrüstung nach GATE-GO 88): Leo-Panels mit falscher Fährte („seltenste Entdeckung"), Tap-Outro, Konfetti an Reveal (8a3db37) + Gate-R3-Spiegel (Grace, 11s, nofoto „Die seltenste Entdeckung … bin ich!"). Sweeps 5+11 grün. → Stufe-2-Review der Nachrüstung steht aus.
