...
- #3 huerden-pferde: Schmiede-Pass 62bb94e (Flo-Panels, goalphoto-Flood, Miss-Band an ZONE_LO, Initial-Spawn). Gate-R2-Spiegel 75c372d + Gate-R3-Spiegel (Grace, 11s, nofoto „Der Champion bist DU!", winWho-Attribution, Anführungszeichen). Sweeps 5+11 grün. → eigenes Gate steht aus (nach lianen-R4).
