...
function ControlHub({ mottoId, szActive, setSzActive, setSzThemeId, childName, age, motto }) {
  return /* @__PURE__ */ React.createElement("div", { className: "no-print", style: {
    ...
    if (!szActive && mottoId && SZ_THEMES.find((t) => t.id === mottoId)) setSzThemeId(mottoId);
    ...
    cursor: "pointer",
    fontFamily: "var(--f)"
  } }, szActive ? "\u2705 Schnitzeljagd" : "\u{1F5FA}\uFE0F Schnitzeljagd"), /* @__PURE__ */ React.createElement("a", { href: `https://party.machsleicht.de?${new URLSearchParams({ ...childName ? { childName } : {}, ...age ? { age } : {}, ...motto?.name ? { motto: motto.name } : {}, ...motto?.emoji ? { mottoEmoji: motto.emoji } : {} }).toString()}`, target: "_blank", rel: "noopener", style: {
    flex: 1,
    padding: 10,
    borderRadius: 10,
    background: "#25D366",
...
const MAP_THEMES = {
  piraten: { parchment: ["#F5E6C8", "#EDD9B3", "#D4B896"], accent: "#5D4037", pathColor: "rgba(139,69,19,0.45)", borderColor: "#8B6914", scatter: ["\u{1F30A}", "\u{1F30A}", "\u2693", "\u{1F99C}", "\u{1F419}", "\u{1F480}", "\u26F5", "\u{1F334}", "\u{1F334}", "\u{1F41A}", "\u{1F5E1}\uFE0F", "\u{1F3F4}\u200D\u2620\uFE0F", "\u{1F988}", "\u{1F30A}", "\u{1F41A}"], pathDeco: ["\u{1F41A}", "\u2693", "\u{1F99C}", "\u{1F480}"], treasureIcon: "\u{1F4B0}", startIcon: "\u26F5" },
  dschungel: { parchment: ["#E0ECDA", "#D0E0C4", "#BCD4A8"], accent: "#D4A574", pathColor: "rgba(27,94,32,0.4)", borderColor: "#33691E", scatter: ["\u{1F334}", "\u{1F334}", "\u{1F33F}", "\u{1F33F}", "\u{1F412}", "\u{1F98E}", "\u{1F40D}", "\u{1F99C}", "\u{1F33A}", "\u{1F343}", "\u{1FABB}", "\u{1F438}", "\u{1F578}\uFE0F", "\u{1F43E}", "\u{1F343}"], pathDeco: ["\u{1F43E}", "\u{1F33F}", "\u{1F99C}", "\u{1F343}"], treasureIcon: "\u{1FAB6}", startIcon: "\u{1F9ED}" },
  weltraum: { parchment: ["#1a1a3e", "#12123a", "#0a0a2e"], accent: "#283593", pathColor: "rgba(124,77,255,0.45)", borderColor: "#536DFE", scatter: ["\u2B50", "\u2B50", "\u2B50", "\u2728", "\u2728", "\u{1F319}", "\u{1FA90}", "\u2604\uFE0F", "\u{1F6F8}", "\u{1F30C}", "\u{1F6F0}\uFE0F", "\u{1F4AB}", "\u2B50", "\u2728", "\u{1F31F}"], pathDeco: ["\u2B50", "\u2728", "\u{1F4AB}", "\u2604\uFE0F"], treasureIcon: "\u{1F6F8}", startIcon: "\u{1F680}", darkMode: true },
  detektiv: { parchment: ["#E8E4F0", "#DDD8EA", "#CCC6DC"], accent: "#455A64", pathColor: "rgba(26,35,126,0.35)", borderColor: "#3949AB", scatter: ["\u{1F50D}", "\u{1F463}", "\u{1F463}", "\u{1F463}", "\u{1F575}\uFE0F", "\u{1F4CB}", "\u{1F526}", "\u{1F58A}\uFE0F", "\u{1F510}", "\u{1F4CE}", "\u{1F9F2}", "\u{1F576}\uFE0F", "\u{1F4A1}", "\u{1F6A8}", "\u{1F463}"], pathDeco: ["\u{1F463}", "\u{1F50D}", "\u{1F4CE}", "\u{1F526}"], treasureIcon: "\u{1F4E6}", startIcon: "\u{1F694}" },
  dino: { parchment: ["#E8F0E0", "#D8E8C8", "#C4D8B0"], accent: "#795548", pathColor: "rgba(46,125,50,0.35)", borderColor: "#558B2F", scatter: ["\u{1F9B4}", "\u{1F9B4}", "\u{1F9B6}", "\u{1F9B6}", "\u{1F33F}", "\u{1F33F}", "\u{1F30B}", "\u{1F95A}", "\u{1F98E}", "\u{1FAA8}", "\u{1F995}", "\u{1F996}", "\u{1F33F}", "\u2604\uFE0F", "\u{1FAB9}"], pathDeco: ["\u{1F9B4}", "\u{1F9B6}", "\u{1F33F}", "\u{1FAA8}"], treasureIcon: "\u{1F9B4}", startIcon: "\u26CF\uFE0F" },
  feen: { parchment: ["#FFF0F5", "#FFE4EE", "#FFD6E8"], accent: "#AB47BC", pathColor: "rgba(173,20,87,0.3)", borderColor: "#E91E63", scatter: ["\u{1F98B}", "\u{1F98B}", "\u2728", "\u2728", "\u{1F338}", "\u{1F338}", "\u{1F344}", "\u{1F308}", "\u{1F48E}", "\u{1F9DA}", "\u{1FAB7}", "\u{1F33A}", "\u{1F4AB}", "\u{1FAE7}", "\u{1F337}"], pathDeco: ["\u{1F98B}", "\u2728", "\u{1F338}", "\u{1F48E}"], treasureIcon: "\u2728", startIcon: "\u{1F9DA}" },
  safari: { parchment: ["#F5ECD0", "#EDE0B8", "#D4C898"], accent: "#8D6E27", pathColor: "rgba(139,110,39,0.4)", borderColor: "#A68B3C", scatter: ["\u{1F981}", "\u{1F981}", "\u{1F418}", "\u{1F992}", "\u{1F993}", "\u{1F334}", "\u{1F334}", "\u{1F33E}", "\u{1F33E}", "\u{1F406}", "\u{1F98F}", "\u{1F40A}", "\u{1F305}", "\u{1F43E}", "\u{1F9A9}"], pathDeco: ["\u{1F43E}", "\u{1F33E}", "\u{1F981}", "\u{1F418}"], treasureIcon: "\u{1F3C6}", startIcon: "\u{1F9ED}" },
  einhorn: { parchment: ["#F8F0FF", "#F0E4FF", "#E4D4FF"], accent: "#EC407A", pathColor: "rgba(236,64,122,0.3)", borderColor: "#E91E63", scatter: ["\u{1F984}", "\u{1F984}", "\u{1F308}", "\u{1F308}", "\u2B50", "\u2728", "\u2728", "\u{1F496}", "\u{1F49C}", "\u{1F338}", "\u{1F380}", "\u{1F48E}", "\u{1FAE7}", "\u{1F31F}", "\u{1F4AB}"], pathDeco: ["\u2728", "\u{1F308}", "\u{1F496}", "\u2B50"], treasureIcon: "\u{1F48E}", startIcon: "\u{1F984}" },
  feuerwehr: { parchment: ["#FFF0E6", "#FFE4D0", "#FFD4B8"], accent: "#D32F2F", pathColor: "rgba(211,47,47,0.35)", borderColor: "#D32F2F", scatter: ["\u{1F525}", "\u{1F525}", "\u{1F692}", "\u{1F692}", "\u{1F9EF}", "\u{1FA9C}", "\u{1F468}\u200D\u{1F692}", "\u{1F3E2}", "\u{1F4A7}", "\u{1F4A7}", "\u{1F6A8}", "\u{1F4DF}", "\u{1F514}", "\u{1FAA3}", "\u{1F525}"], pathDeco: ["\u{1F525}", "\u{1F4A7}", "\u{1F6A8}", "\u{1F9EF}"], treasureIcon: "\u{1F3C5}", startIcon: "\u{1F692}" }
};
const LOCATION_EMOJI_MAP = [
  [/rutsche/i, "\u{1F6DD}"],
  [/schaukel/i, "\u{1F3A0}"],
  [/wippe/i, "\u{1F3A0}"],
  [/kletterger[üu]/i, "\u{1F9D7}"],
  [/sandkasten|sandkiste/i, "\u{1F3D6}\uFE0F"],
  [/baum|birke|eiche|linde/i, "\u{1F333}"],
  [/busch|hecke|str[äa]uch/i, "\u{1F33F}"],
  [/blume|beet|rose/i, "\u{1F338}"],
  [/pflanze|topf|blumentopf/i, "\u{1FAB4}"],
  [/garten|rasen|wiese/i, "\u{1F33B}"],
  [/terrasse|veranda/i, "\u2600\uFE0F"],
  [/balkon/i, "\u{1F305}"],
  [/zaun|tor(?!te)/i, "\u{1F3D7}\uFE0F"],
  [/brunnen/i, "\u26F2"],
  [/teich|see|wasser/i, "\u{1F438}"],
  [/pool|planschbecken/i, "\u{1F3CA}"],
  [/grill/i, "\u{1F525}"],
  [/garage/i, "\u{1F3E0}"],
  [/schuppen|gartenhaus/i, "\u{1F3DA}\uFE0F"],
  [/hundeh[üu]tte/i, "\u{1F415}"],
  [/auto|wagen/i, "\u{1F697}"],
  [/fahrrad|rad/i, "\u{1F6B2}"],
  [/briefkasten/i, "\u{1F4EE}"],
  [/m[üu]ll/i, "\u{1F5D1}\uFE0F"],
  [/stein|fels/i, "\u{1FAA8}"],
  [/bank/i, "\u{1FA91}"],
  [/spielplatz/i, "\u{1F3AA}"],
  [/t[üu]r|eingang/i, "\u{1F6AA}"],
  [/treppe|stufe/i, "\u{1FA9C}"],
  [/fenster/i, "\u{1FA9F}"],
  [/keller/i, "\u{1F526}"],
  [/dachboden|dach/i, "\u{1F3DA}\uFE0F"],
  [/k[üu]che|herd/i, "\u{1F373}"],
  [/k[üu]hlschrank/i, "\u{1F9CA}"],
  [/bad(?!ewanne)|waschbecken/i, "\u{1F6C1}"],
  [/dusche/i, "\u{1F6BF}"],
  [/toilette|klo/i, "\u{1F6BD}"],
  [/badewanne|wanne/i, "\u{1F6C1}"],
  [/sofa|couch/i, "\u{1F6CB}\uFE0F"],
  [/bett|matratze/i, "\u{1F6CF}\uFE0F"],
  [/kissen/i, "\u{1F6CB}\uFE0F"],
  [/schrank|kommode/i, "\u{1F5C4}\uFE0F"],
  [/tisch|esstisch/i, "\u{1F37D}\uFE0F"],
  [/stuhl|hocker/i, "\u{1F4BA}"],
  [/regal|b[üu]cherregal/i, "\u{1F4DA}"],
  [/waschmaschine|trockner|w[äa]sche/i, "\u{1F9FA}"],
  [/kamin|ofen/i, "\u{1F525}"],
  [/vorhang|gardine/i, "\u{1FA9F}"],
  [/teppich/i, "\u{1F9F6}"],
...
function matchLocationEmoji(text) {
  if (!text) return "";
  for (const [re, em] of LOCATION_EMOJI_MAP) {
    if (re.test(text)) return em;
  }
  return "\u{1F4CD}";
}
function mapSeededRandom(seed) {
  let s = seed;
  return () => {
...
function mapAutoLayout(stationNames, W, H) {
  ...
  for (let i = 0; i < n; i++) {
    const t = (i + 0.5) / n;
    const x = pad + 25 + (W - pad * 2 - 50) * t;
    const phase = t * Math.PI * 2;
    const amp = (H - pad * 2 - 70) * 0.3;
...
function drawTreasureMap(canvas, points, themeId, title, dekoItems, selectedDekoIdx, stationEmojis) {
  ...
  grad.addColorStop(0, t.parchment[0]);
  grad.addColorStop(0.6, t.parchment[1]);
  grad.addColorStop(1, t.parchment[2]);
  ctx.fillStyle = grad;
  ctx.fillRect(0, 0, W, H);
  for (let i = 0; i < 5e3; i++) {
    ctx.fillStyle = isDark ? `rgba(100,100,200,${rng() * 0.12})` : `rgba(120,80,40,${rng() * 0.05})`;
    ctx.fillRect(rng() * W, rng() * H, 1, 1);
  }
  for (let i = 0; i < 3; i++) {
    const sx = rng() * W, sy = rng() * H, sr = 20 + rng() * 40;
    const st = ctx.createRadialGradient(sx, sy, 0, sx, sy, sr);
    st.addColorStop(0, isDark ? "rgba(60,60,120,0.08)" : "rgba(160,120,60,0.06)");
  ...
  ctx.strokeStyle = t.borderColor + "44";
  ctx.lineWidth = 1;
  ctx.strokeRect(12, 12, W - 24, H - 24);
  ctx.textAlign = "center";
  ctx.fillStyle = tc;
  ctx.font = `bold ${W > 400 ? 18 : 14}px Georgia,serif`;
  ctx.fillText(title || "Schatzkarte", W / 2, 30);
  ctx.globalAlpha = isDark ? 0.2 : 0.15;
  t.scatter.forEach((em) => {
    const ex = 25 + rng() * (W - 50), ey = 40 + rng() * (H - 70);
    let skip = false;
    points.forEach((p) => {
      if (Math.hypot(p.x - ex, p.y - ey) < 40) skip = true;
    });
    if (skip) return;
    ctx.font = `${11 + rng() * 8}px serif`;
    ctx.textAlign = "center";
  ...
  if (points.length >= 2) {
    ...
    for (let i = 1; i < points.length; i++) {
      ...
      mids.push({ x: (p1.x + p2.x) / 2 + (rng() - 0.5) * 15, y: (p1.y + p2.y) / 2 + (rng() - 0.5) * 15 });
    }
    ctx.stroke();
    ctx.setLineDash([]);
    ctx.globalAlpha = 0.5;
    mids.forEach((mp) => {
      ...
      ctx.textAlign = "center";
      ctx.textBaseline = "middle";
      ctx.fillText(t.pathDeco[Math.floor(rng() * t.pathDeco.length)], mp.x, mp.y);
    });
    ctx.globalAlpha = 1;
  }
  const ccx = W - 38, ccy = H - 38;
  ctx.save();
  ...
  ctx.stroke();
  [{ a: -Math.PI / 2, l: "N", len: 14, b: true }, { a: 0, l: "O", len: 10 }, { a: Math.PI / 2, l: "S", len: 10 }, { a: Math.PI, l: "W", len: 10 }].forEach((d) => {
    ctx.strokeStyle = d.b ? tc : tcl;
    ctx.lineWidth = d.b ? 2 : 1.5;
    ctx.beginPath();
    ctx.moveTo(0, 0);
    ctx.lineTo(Math.cos(d.a) * d.len, Math.sin(d.a) * d.len);
    ctx.stroke();
    ctx.fillStyle = d.b ? tc : tcl;
    ctx.font = d.b ? "bold 8px Georgia" : "7px Georgia";
    ctx.textAlign = "center";
    ctx.textBaseline = "middle";
    ctx.fillText(d.l, Math.cos(d.a) * (d.len + 7), Math.sin(d.a) * (d.len + 7));
  });
  ctx.restore();
  ...
  points.forEach((p) => {
    if (p.isTreasure) {
      ...
      ctx.textAlign = "center";
      ctx.textBaseline = "middle";
      ctx.fillText(t.treasureIcon, 0, -18);
      ctx.fillStyle = "#CC0000";
      ctx.font = "bold italic 10px Georgia";
      ctx.textBaseline = "alphabetic";
      ctx.fillText("Schatz!", 0, 24);
      ctx.restore();
      return;
    }
    if (p.isStart) {
      ...
      ctx.textAlign = "center";
      ctx.textBaseline = "middle";
      ctx.fillText(t.startIcon, p.x, p.y);
      ctx.fillStyle = tc;
      ctx.font = "bold 8px Georgia";
      ctx.textBaseline = "top";
      ctx.fillText("START", p.x, p.y + 12);
      return;
    }
    ctx.fillStyle = "rgba(0,0,0,0.1)";
    ctx.beginPath();
    ctx.arc(p.x + 1.5, p.y + 1.5, 15, 0, Math.PI * 2);
    ctx.fill();
    ctx.fillStyle = isDark ? "#2a2a5a" : t.parchment[0];
    ...
    ctx.fill();
    ctx.stroke();
    ctx.fillStyle = isDark ? "#fff" : stColor;
  ...
  React.useEffect(() => {
    ...
    const findStationIdx = (x, y) => {
      ...
      for (let i = pts.length - 1; i >= 0; i--) {
        if (Math.hypot(pts[i].x - x, pts[i].y - y) < 25) return i;
      }
      return -1;
    };
...
<div class="page"><h1>${szTheme.emoji} ${nameGen ? nameGen + " " : ""}${szTheme.name}</h1><p style="font-size:13px;color:#6B5D52;margin-bottom:12px">${stations.length} Stationen \xB7 ${ageLabel[ag]} \xB7 ca. ${totalDauer} Min.</p><p style="font-size:14px;color:#5D4037;line-height:1.6;font-style:italic;margin-bottom:16px;padding:12px;background:#FAFAF5;border-radius:8px">\u201E${introText}"</p>${stations.map((s, i) => {
      const loc = stationLocations[i];
      const locLine = loc ? `<div style="font-size:12px;color:#5D4037;margin-top:4px;font-style:italic">\u{1F4CD} Versteck: ${loc}</div>` : "";
      return `<div class="station"><div class="station-name">${i === stations.length - 1 ? "\u{1F381}" : i + 1 + "."} ${s.name}</div>${locLine}<div class="station-desc">${s.desc}</div><div class="hint">\u{1F4A1} ${s.hint}</div></div>`;
    }).join("")}</div>
<div class="page"><h1>\u2702\uFE0F Hinweis-Zettel zum Ausschneiden</h1><p style="font-size:13px;color:#6B5D52;margin-bottom:16px">Ausschneiden und an den Stationen verstecken.</p><div class="hinweis-grid">${stations.map((s, i) => {
      const nextLoc = stationLocations[i + 1];
      const thisLoc = stationLocations[i];
      const nextLabel = i < stations.length - 1 ? nextLoc ? nextLoc : stations[i + 1].name : null;
      const hideHint = thisLoc ? `<div style="font-size:10px;color:#795548;margin-top:8px;border-top:1px dashed ${szTheme.color}40;padding-top:6px">\u{1F4CD} Verstecke hier: ${thisLoc}</div>` : "";
      return `<div class="hinweis-card"><div style="font-size:28px;margin-bottom:4px">${i === stations.length - 1 ? "\u{1F381}" : "Station " + (i + 1)}</div><div style="font-size:13px;font-weight:700;margin-bottom:6px">${s.name}</div><div style="font-size:16px;color:#5D4037;font-family:'Caveat',cursive">${nextLabel ? "\u2192 Weiter zu: " + nextLabel : "\u{1F389} Geschafft! Hier ist der Schatz!"}</div>${hideHint}</div>`;
    }).join("")}</div></div>
...
<div class="page" style="display:flex;justify-content:center;align-items:center"><div class="cert"><div style="font-size:56px;margin-bottom:12px">${szTheme.emoji}</div><div style="font-size:28px;font-weight:900;margin-bottom:6px">Urkunde</div><div style="font-size:18px;color:#6B5D52;margin-bottom:24px">${szTheme.name}</div><div style="font-size:32px;font-weight:900;color:${szTheme.color};padding:8px 0;border-bottom:2px solid ${szTheme.color}40;margin-bottom:16px">_______________</div><div style="font-size:15px;color:#6B5D52;line-height:1.6;margin:16px 0">hat die gro\xDFe ${szTheme.name} erfolgreich bestanden!<br>Alle ${stations.length} Stationen gemeistert.</div><div style="display:flex;justify-content:space-between;margin-top:32px;font-size:13px;color:#A89888"><div style="border-top:1px solid #CCC;padding-top:4px;min-width:140px;text-align:center">Datum</div><div style="border-top:1px solid #CCC;padding-top:4px;min-width:140px;text-align:center">Unterschrift</div></div><div style="font-size:10px;color:#A89888;margin-top:16px">machsleicht.de</div></div></div>
  ...
  if (!szActive) return /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
    if (mottoId && SZ_THEMES.find((t) => t.id === mottoId)) setSzThemeId(mottoId);
    setSzActive(true);
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { style: { borderRadius: 20, border: `2px solid ${szTheme ? szTheme.color + "40" : "var(--a)"}`, overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "linear-gradient(135deg,#e8d5b7,#d4bc94)", padding: "16px 18px", display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 17, fontWeight: 900, color: "var(--d)", margin: "0 0 2px" } }, "\u{1F5FA}\uFE0F Schnitzeljagd ", szTheme ? `\xB7 ${szTheme.name}` : ""), szTheme && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--d)", opacity: 0.6, margin: 0 } }, stations.length, " Stationen \xB7 ", ageLabel[ag], " \xB7 ", totalDauer, " Min.")), /* @__PURE__ */ React.createElement("button", { onClick: () => setSzActive(false), style: { background: "rgba(255,255,255,0.5)", border: "none", borderRadius: 8, padding: "4px 10px", fontSize: 11, fontWeight: 700, cursor: "pointer", color: "var(--d)" } }, "\u2715")), /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 18px", background: "var(--bg)" } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, fontWeight: 700, color: "var(--m)", marginBottom: 8, textTransform: "uppercase", letterSpacing: "0.06em" } }, "Thema w\xE4hlen"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(90px, 1fr))", gap: 6 } }, SZ_THEMES.map((t) => /* @__PURE__ */ React.createElement("button", { key: t.id, onClick: () => setSzThemeId(t.id), style: {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: i, style: { marginBottom: 8 } }, /* @__PURE__ */ React.createElement("details", { open: i === 0, style: { marginBottom: 0 } }, /* @__PURE__ */ React.createElement("summary", { style: { display: "flex", alignItems: "center", gap: 8, cursor: "pointer", padding: "6px 0", fontSize: 13, listStyle: "none" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 22, height: 22, borderRadius: "50%", background: isLast ? "var(--a)" : szTheme.color, color: "#fff", fontSize: 9, fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0 } }, isLast ? "\u{1F381}" : i + 1), /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 700, flex: 1 } }, st.name), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "var(--m)" } }, st.dauer, "\u2032"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "var(--l)", flexShrink: 0, transition: "transform 0.2s" } }, "\u25BC")), /* @__PURE__ */ React.createElement("div", { style: { paddingLeft: 30, paddingBottom: 6 } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--m)", lineHeight: 1.5, margin: "4px 0 6px" } }, st.desc), st.hint && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "#795548", background: "#FFF8E1", padding: "6px 10px", borderRadius: 6, border: "1px solid #FFE082" } }, "\u{1F4A1} ", st.hint))), !isLast && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginLeft: 30, marginTop: 2 } }, locEmoji && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, flexShrink: 0 } }, locEmoji), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
        value: locText,
...
function VorbereitungsKarte({ preparationWeeks, mottoColor }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24, background: "#fff", border: "1px solid var(--l)", borderRadius: 14, padding: "18px 18px 14px" } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, fontWeight: 700, letterSpacing: 1.5, color: mottoColor || "var(--a)", textTransform: "uppercase", marginBottom: 6 } }, "\u{1F4C5} Vorbereitung"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 18, fontWeight: 800, marginBottom: 10, color: "var(--d)" } }, "Vorbereitungs-Wochen"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--m)", marginBottom: 14, lineHeight: 1.5 } }, "Wann was zu tun ist \u2014 vom Datum-Fixieren bis zum Tag X. Klick eine Sektion zum Aufklappen."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, ORDER.map((key) => {
    const sec = preparationWeeks[key];
    if (!sec) return null;
    return /* @__PURE__ */ React.createElement(PrepSection, { key, sectionKey: key, section: sec, mottoColor });
  })));
}
function PrepSection({ sectionKey, section, mottoColor }) {
  const [open, setOpen] = useState(sectionKey === "minus4Weeks");
  return /* @__PURE__ */ React.createElement("div", { style: { border: "1px solid var(--l)", borderRadius: 10, overflow: "hidden" } }, /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 700, color: "var(--d)" } }, section.headline),
    /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, color: mottoColor || "var(--a)" } }, open ? "\u25BE" : "\u25B8")
  ), open && /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 14px 14px", background: "#fff" } }, section.items.map((item, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 10, padding: "8px 0", borderBottom: i < section.items.length - 1 ? "1px solid var(--l)" : "none" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 20, flexShrink: 0 } }, item.icon), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("strong", { style: { fontSize: 13, color: "var(--d)", display: "block", marginBottom: 2 } }, item.title), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "var(--m)", lineHeight: 1.5 } }, item.detail))))));
}
function SOSButton({ sosScenarios, mottoColor }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 18, fontWeight: 800, color: "var(--d)", margin: 0 } }, selected ? selected.label : "\u{1F6A8} SOS \u2014 Was ist los?"), /* @__PURE__ */ React.createElement(
        "button",
        {
        ...
        selected ? "\u2190 Zur\xFCck" : "Schlie\xDFen"
      )),
      !selected ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, scenarios.map(([key, sc]) => /* @__PURE__ */ React.createElement(
        "button",
        {
          key,
        ...
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 24 } }, sc.icon),
        /* @__PURE__ */ React.createElement("span", { style: { flex: 1, fontSize: 14, fontWeight: 600, color: "var(--d)" } }, sc.label),
        /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16, color: mottoColor || "var(--a)" } }, "\u2192")
      ))) : /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 15, fontWeight: 700, color: "var(--d)", marginBottom: 14, lineHeight: 1.4 } }, selected.headline), /* @__PURE__ */ React.createElement("ol", { style: { paddingLeft: 22, marginBottom: 14 } }, selected.steps.map((step, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: { fontSize: 13, color: "var(--d)", marginBottom: 8, lineHeight: 1.5 } }, step))), selected.fallback && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, padding: 12, background: "var(--bg)", borderLeft: `3px solid ${mottoColor || "var(--a)"}`, borderRadius: 4 } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, fontWeight: 700, color: "var(--m)", margin: "0 0 4px", textTransform: "uppercase", letterSpacing: 1 } }, "Plan C"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--d)", margin: 0, lineHeight: 1.5 } }, selected.fallback)))
    )
  ));
}
function EliteShoppingList({ variants, shoppingMode, mottoColor }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24, background: "#fff", border: "1px solid var(--l)", borderRadius: 14, padding: "18px 18px 14px" } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, fontWeight: 700, letterSpacing: 1.5, color: mottoColor || "var(--a)", textTransform: "uppercase", marginBottom: 6 } }, "\u{1F6D2} Einkaufsliste"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 18, fontWeight: 800, marginBottom: 6, color: "var(--d)" } }, variant.label || `${variant.id} \u2014 ca. ${variant.estimatedCostEur || total}\u20AC`), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--m)", marginBottom: 14, lineHeight: 1.5 } }, 'Drei Gruppen statt einer langen Liste. Fang oben an, h\xF6r unten auf \u2014 alles unter \u201EHab ich vielleicht schon" kannst du wahrscheinlich \xFCberspringen.'), ["pflicht", "sinnvoll", "habIchVielleicht"].map((catKey) => {
    const items = groups[catKey];
    if (!items.length) return null;
    const meta = GROUP_META[catKey];
    const sum = items.reduce((acc, it) => acc + (typeof it.priceEur === "number" ? it.priceEur : 0), 0);
    return /* @__PURE__ */ React.createElement("div", { key: catKey, style: { marginBottom: 16 } }, /* @__PURE__ */ React.createElement("h3", { style: { fontSize: 14, fontWeight: 700, color: meta.color, marginBottom: 8, display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { style: { marginRight: 6 } }, meta.emoji), meta.label), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "var(--m)", fontWeight: 600 } }, items.length, " \xB7 ca. ", sum, "\u20AC")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, items.map((item, i) => /* @__PURE__ */ React.createElement(EliteShoppingItem, { key: `${catKey}-${i}`, item, categoryColor: meta.color }))));
  }));
}
function EliteShoppingItem({ item, categoryColor }) {
  const [expanded, setExpanded] = useState(false);
  const priceLabel = item.priceEur === 0 ? "0 \u20AC" : `${item.priceEur} \u20AC`;
  return /* @__PURE__ */ React.createElement("div", { style: { border: "1px solid var(--l)", borderRadius: 8, padding: "10px 12px", background: "#fff" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 20 } }, item.emoji || "\u2022"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } }, item.url ? /* @__PURE__ */ React.createElement("a", { href: item.url, target: "_blank", rel: "noopener", style: { fontSize: 13, fontWeight: 600, color: "var(--d)", textDecoration: "none", borderBottom: `1px dashed ${categoryColor}` } }, item.label) : /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 600, color: "var(--d)" } }, item.label)), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 800, color: categoryColor, flexShrink: 0 } }, priceLabel)), item.categoryReasoning && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("button", { onClick: () => setExpanded(!expanded), style: { marginTop: 6, background: "none", border: "none", padding: 0, fontSize: 11, color: "var(--m)", cursor: "pointer", textDecoration: "underline" } }, expanded ? "Warum-Begr\xFCndung ausblenden" : "Warum diese Kategorie?"), expanded && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "var(--m)", marginTop: 4, lineHeight: 1.5, fontStyle: "italic" } }, item.categoryReasoning)));
}
function EliteCockpitHeader({ eliteData, mottoColor, mottoName }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 16, background: "#fff", border: `1px dashed ${mottoColor || "var(--a)"}`, borderRadius: 12, padding: "14px 16px" } }, ai && /* @__PURE__ */ React.createElement("details", { style: { marginBottom: sr && sr.name ? 10 : 0 } }, /* @__PURE__ */ React.createElement("summary", { style: { fontSize: 13, fontWeight: 700, color: "var(--d)", cursor: "pointer", padding: "2px 0", listStyle: "none" } }, /* @__PURE__ */ React.createElement("span", { style: { color: mottoColor || "var(--a)" } }, "\u{1F9E0}"), " ", ai.headline || "Was du \xFCber die Altersgruppe wissen musst", " \u25BE"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, paddingLeft: 6 } }, ai.traits && ai.traits.length > 0 && /* @__PURE__ */ React.createElement("ul", { style: { paddingLeft: 18, marginBottom: 10 } }, ai.traits.slice(0, 7).map((t, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: { fontSize: 12, color: "var(--m)", marginBottom: 4, lineHeight: 1.5 } }, /* @__PURE__ */ React.createElement("strong", { style: { color: "var(--d)" } }, t.topic, ":"), " ", t.detail))), ai.whyMottoFits && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--d)", lineHeight: 1.5, marginTop: 8, padding: 10, background: "var(--bg)", borderRadius: 8 } }, /* @__PURE__ */ React.createElement("strong", null, ai.whyMottoFitsHeadline || "Warum passt das Motto:"), " ", ai.whyMottoFits))), sr && sr.name && /* @__PURE__ */ React.createElement("details", { onToggle: (e) => setShowRitual(e.target.open) }, /* @__PURE__ */ React.createElement("summary", { style: { fontSize: 13, fontWeight: 700, color: "var(--d)", cursor: "pointer", padding: "2px 0", listStyle: "none" } }, /* @__PURE__ */ React.createElement("span", { style: { color: mottoColor || "var(--a)" } }, "\u2728"), " Signature-Ritual: ", sr.name, " \u25BE"), showRitual && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, paddingLeft: 6 } }, sr.introText && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--m)", lineHeight: 1.5, marginBottom: 10 } }, sr.introText), sr.setupSteps && sr.setupSteps.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, fontWeight: 700, color: "var(--d)", marginBottom: 4, textTransform: "uppercase", letterSpacing: 1 } }, "So geht's:"), /* @__PURE__ */ React.createElement("ol", { style: { paddingLeft: 18, margin: 0 } }, sr.setupSteps.map((s, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: { fontSize: 12, color: "var(--d)", marginBottom: 4, lineHeight: 1.5 } }, /* @__PURE__ */ React.createElement("strong", null, s.title), s.content ? ` \u2014 ${s.content}` : "")))), sr.rolesList && sr.rolesList.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, fontWeight: 700, color: "var(--d)", marginBottom: 4, textTransform: "uppercase", letterSpacing: 1 } }, sr.rolesList.length, " Namen / Rollen zum Ziehen:"), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(140px, 1fr))", gap: 4 } }, sr.rolesList.map((r, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { fontSize: 11, color: "var(--d)", padding: "4px 6px", background: "var(--bg)", borderRadius: 6 } }, /* @__PURE__ */ React.createElement("span", null, r.emoji || "\u2728"), " ", r.name, r.function ? ` \xB7 ${r.function}` : "")))), sr.optOutNote && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "var(--m)", marginTop: 8, padding: 8, background: "var(--bg)", borderRadius: 6, fontStyle: "italic", lineHeight: 1.4 } }, /* @__PURE__ */ React.createElement("strong", null, "Wenn ein Kind nicht will:"), " ", sr.optOutNote))));
}
function EliteGamesFilter({ variants, shoppingMode, effectiveLoc, quietMode, mottoColor }) {
  const [showAll, setShowAll] = useState(false);
  const [filterEffort, setFilterEffort] = useState("alle");
  const [filterLoud, setFilterLoud] = useState("alle");
  if (!variants || variants.length === 0) return null;
  const targetVariantId = shoppingMode === "minimal" ? "minimal" : shoppingMode === "wow" ? "wow" : "standard";
  const variant = variants.find((v) => v.id === targetVariantId) || variants[0];
  if (!variant || !variant.games || variant.games.length === 0) return null;
  const locationConstraint = effectiveLoc === "wohnung" ? "indoor" : "outdoor";
  const filtered = variant.games.filter((g) => {
    if (locationConstraint === "indoor" && !g.indoor) return false;
    if (locationConstraint === "outdoor" && !g.outdoor && !g.indoor) return false;
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24, background: "#fff", border: "1px solid var(--l)", borderRadius: 14, padding: "16px 18px" } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, fontWeight: 700, letterSpacing: 1.5, color: mottoColor || "var(--a)", textTransform: "uppercase", marginBottom: 4 } }, "\u{1F3AE} Spiele \xB7 Constraint-Solver"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 18, fontWeight: 800, marginBottom: 4, color: "var(--d)" } }, "Spiele passend zu deinem Setup"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--m)", marginBottom: 12 } }, "Gefiltert nach: ", /* @__PURE__ */ React.createElement("strong", null, effectiveLoc === "wohnung" ? "Drinnen" : "Outdoor-tauglich"), quietMode && /* @__PURE__ */ React.createElement("span", { style: { color: "#558B2F" } }, " \xB7 Ruhig-Modus aktiv"), " \xB7 ", filtered.length, " von ", variant.games.length, " Spielen \xB7 gesamt ~", totalDur, " Min."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 12 } }, /* @__PURE__ */ React.createElement("select", { value: filterEffort, onChange: (e) => setFilterEffort(e.target.value), style: { fontSize: 11, padding: "4px 8px", border: "1px solid var(--l)", borderRadius: 6, background: "#fff", color: "var(--d)" } }, /* @__PURE__ */ React.createElement("option", { value: "alle" }, "Aufwand: alle"), /* @__PURE__ */ React.createElement("option", { value: "leicht" }, "leicht"), /* @__PURE__ */ React.createElement("option", { value: "mittel" }, "mittel"), /* @__PURE__ */ React.createElement("option", { value: "hoch" }, "hoch")), /* @__PURE__ */ React.createElement("select", { value: filterLoud, onChange: (e) => setFilterLoud(e.target.value), style: { fontSize: 11, padding: "4px 8px", border: "1px solid var(--l)", borderRadius: 6, background: "#fff", color: "var(--d)" }, disabled: quietMode }, /* @__PURE__ */ React.createElement("option", { value: "alle" }, "Lautst\xE4rke: alle"), /* @__PURE__ */ React.createElement("option", { value: "ruhig" }, "ruhig"), /* @__PURE__ */ React.createElement("option", { value: "mittel" }, "mittel"), /* @__PURE__ */ React.createElement("option", { value: "laut" }, "laut"))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, filtered.length === 0 ? /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--m)", padding: 12, background: "var(--bg)", borderRadius: 8, textAlign: "center" } }, `Keine Spiele entsprechen den Filtern. Lock'rer machen \u2014 Aufwand oder Lautst\xE4rke auf "alle".`) : (showAll ? filtered : filtered.slice(0, 4)).map((g, i) => /* @__PURE__ */ React.createElement(EliteGameCard, { key: i, game: g, mottoColor })), filtered.length > 4 && /* @__PURE__ */ React.createElement("button", { onClick: () => setShowAll(!showAll), style: { background: "none", border: `1px dashed ${mottoColor || "var(--a)"}`, padding: "8px 12px", borderRadius: 8, color: "var(--m)", fontSize: 12, cursor: "pointer", fontFamily: "inherit" } }, showAll ? "Weniger anzeigen" : `Alle ${filtered.length} anzeigen`)));
}
function EliteGameCard({ game, mottoColor }) {
  ...
  if (game.loudness) badges.push(`${game.loudness === "ruhig" ? "\u{1F508}" : game.loudness === "mittel" ? "\u{1F509}" : "\u{1F50A}"} ${game.loudness}`);
  if (game.indoor && game.outdoor) badges.push("\u{1F3E0}/\u{1F333} in/out");
  else if (game.indoor) badges.push("\u{1F3E0} drinnen");
  else if (game.outdoor) badges.push("\u{1F333} drau\xDFen");
  return /* @__PURE__ */ React.createElement("div", { style: { border: "1px solid var(--l)", borderRadius: 10, padding: "12px 14px", background: "#fff" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 } }, /* @__PURE__ */ React.createElement("h3", { style: { fontSize: 14, fontWeight: 700, color: "var(--d)", margin: 0, flex: 1 } }, game.name), /* @__PURE__ */ React.createElement("button", { onClick: () => setExpanded(!expanded), style: { background: "none", border: "none", padding: 0, fontSize: 11, color: mottoColor || "var(--a)", cursor: "pointer", flexShrink: 0 } }, expanded ? "\u25B4" : "\u25BE")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginTop: 4 } }, badges.map((b, i) => /* @__PURE__ */ React.createElement("span", { key: i, style: { fontSize: 10, padding: "2px 6px", background: "var(--bg)", color: "var(--m)", borderRadius: 4, fontWeight: 600 } }, b))), expanded && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10, fontSize: 12, color: "var(--d)", lineHeight: 1.5 } }, game.material && /* @__PURE__ */ React.createElement("p", { style: { marginBottom: 6 } }, /* @__PURE__ */ React.createElement("strong", null, "Material:"), " ", game.material), game.prepText && /* @__PURE__ */ React.createElement("p", { style: { marginBottom: 6 } }, /* @__PURE__ */ React.createElement("strong", null, "Vorbereitung:"), " ", game.prepText), game.steps && game.steps.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 6 } }, /* @__PURE__ */ React.createElement("strong", null, "Ablauf:"), /* @__PURE__ */ React.createElement("ol", { style: { paddingLeft: 18, margin: "4px 0 0" } }, game.steps.map((s, i) => /* @__PURE__ */ React.createElement("li", { key: i, style: { marginBottom: 3 } }, /* @__PURE__ */ React.createElement("strong", null, s.name, ":"), " ", s.content)))), game.safetyRule && /* @__PURE__ */ React.createElement("p", { style: { marginBottom: 6, padding: 6, background: "#FFF3E0", borderRadius: 4 } }, /* @__PURE__ */ React.createElement("strong", null, "\u26A0\uFE0F Sicherheit:"), " ", game.safetyRule), game.whyItWorks && /* @__PURE__ */ React.createElement("p", { style: { marginBottom: 6, padding: 6, background: "var(--bg)", borderRadius: 4, fontSize: 11, fontStyle: "italic" } }, /* @__PURE__ */ React.createElement("strong", null, game.whyItWorksTitle || "Warum funktioniert das", ":"), " ", game.whyItWorks)));
}
function App() {
  ...
  useEffect(() => {
    ...
    if (modus === "schatzsuche") {
      setSzActive(true);
      if (!thema) {
        const mid = p.get("motto") || loadState("mottoId", null);
        if (mid && SZ_THEMES.find((t) => t.id === mid)) setSzThemeId(mid);
      }
    }
  ...
  useEffect(() => {
    if (view === "plan" && motto && window.plausible) plausible("plan-created", { props: { motto: mottoId, alter: age, gaeste: guests, szActive, thema: szThemeId } });
    ...
    if (view === "plan" && motto && window.umami) {
      try {
        window.umami.track("cockpit_viewed", { motto: mottoId, alter: age });
      } catch (e) {
      }
    }
  }, [mottoId, view]);
  ...
  async function submitPartyForm() {
    ...
    try {
      ...
      if (window.umami) {
        try {
          window.umami.track("party_created", { motto: mottoId });
        } catch (e) {
        }
      }
      if (wantsEmail) {
  ...
  function copyToClipboard(text) {
    if (navigator.clipboard) {
      navigator.clipboard.writeText(text).then(function() {
        if (window.umami) {
          try {
            window.umami.track("party_share_clicked", { channel: "copy" });
          } catch (e) {
          }
        }
      });
  ...
  function shareParty(url) {
    if (!motto) return;
    const msg = encodeURIComponent("\u{1F389} " + motto.emoji + " Du bist eingeladen zum " + motto.name + "-Geburtstag" + (childName ? " von " + childName : "") + "! Hier sind alle Infos & Zusagen:\n" + url);
    window.open("https://wa.me/?text=" + msg, "_blank");
    if (window.umami) {
      try {
        window.umami.track("party_share_clicked", { channel: "whatsapp" });
      } catch (e) {
      }
    }
  }
  ...
  function getDeko() {
    ...
    const wowExtras = isWow ? [
      { name: "Foto-Hintergrund " + motto.name, price: 14.99, eco: false, bbl: "buy", emoji: "\u{1F4F8}", url: "https://www.amazon.de/s?k=" + encodeURIComponent(motto.name + " foto hintergrund party kinder") + "&tag=machsleicht-21" },
  ...
  const mottoDescs = {
    ...
    detektiv: "Lupe raus, Fingerabdr\xFCcke nehmen, Verd\xE4chtige verh\xF6ren \u2014 die kleinen Detektive l\xF6sen jeden Fall!",
    dschungel: "Tarzan-Schwung, Tierspuren-Lesen, Br\xFCckenbau \u2014 eine Expedition durch den wilden Dschungel.",
...
https://machsleicht.de`;
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 660, margin: "0 auto", padding: "0 16px 80px" } }, /* @__PURE__ */ React.createElement("header", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 0 18px", position: "sticky", top: 0, background: "var(--w)", zIndex: 10, borderBottom: "1px solid var(--l)" } }, /* @__PURE__ */ React.createElement("a", { href: "/", style: { textDecoration: "none" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--fd)", fontSize: 22, fontWeight: 900, color: "var(--d)" } }, "mach's"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--fd)", fontSize: 22, fontWeight: 900, color: "var(--a)" } }, "leicht")), /* @__PURE__ */ React.createElement("button", { onClick: reset, style: { background: "none", border: "1px solid var(--l)", borderRadius: "var(--rs)", padding: "6px 14px", fontSize: 12, color: "var(--m)", cursor: "pointer" } }, "\u2190 Neu")), /* @__PURE__ */ React.createElement("section", { className: "fu", style: { textAlign: "center", padding: "20px 0 16px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 48, marginBottom: 8 } }, motto.emoji), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--fd)", fontSize: 26, fontWeight: 900, marginBottom: 4 } }, motto.name), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 14, color: "var(--m)" } }, guests, " Kinder \xB7 ", age, " Jahre \xB7 ", duration, " Std. \xB7 ", locLabel, isMinimal && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--g)", fontWeight: 600 } }, " \xB7 \u{1F33F} Minimal"), isWow && /* @__PURE__ */ React.createElement("span", { style: { color: "#7B1FA2", fontWeight: 600 } }, " \xB7 \u2728 Wow"), emergencyMode && /* @__PURE__ */ React.createElement("span", { style: { color: "#C62828", fontWeight: 600 } }, " \xB7 \u{1F6A8} Morgen-Modus")), motto.cat === "license" && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--a)", marginTop: 4 } }, "Spiele passen zum Thema \u2014 Deko & Mitgebsel sind original ", motto.name, " Produkte.")), eliteData && /* @__PURE__ */ React.createElement(EliteCockpitHeader, { eliteData, mottoColor: motto.color, mottoName: motto.name }), /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24, background: "linear-gradient(135deg, #FFF3E8 0%, #FFFAF5 100%)", border: "1px solid var(--l)", borderRadius: 14, padding: "16px 18px" } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, fontWeight: 700, letterSpacing: 1.5, color: motto.color || "var(--a)", textTransform: "uppercase", marginBottom: 6 } }, "\u2713 Dein Plan steht"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 18, fontWeight: 800, marginBottom: 10, color: "var(--d)" } }, "Als N\xE4chstes sinnvoll"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--m)", marginBottom: 12, lineHeight: 1.5 } }, "Du musst nichts davon machen \u2014 alles funktioniert einzeln. Aber wenn du magst, machen wir dir die n\xE4chsten Schritte einfach."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          ...
          if (window.umami) {
            try {
              window.umami.track("cockpit_cta_clicked", { target: "treasure", motto: mottoId });
            } catch (e) {
            }
          }
          setTimeout(() => {
            const el = document.querySelector('[data-section="schatzsuche"]');
      ...
      /* @__PURE__ */ React.createElement("span", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("strong", { style: { fontSize: 14, color: "var(--d)", display: "block" } }, motto.name, "-Schatzsuche erstellen"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "var(--m)" } }, "Stationen, Karte und Hinweise \u2014 passend zum Alter")),
      /* @__PURE__ */ React.createElement("span", { style: { fontSize: 18, color: "var(--a)" } }, "\u2192")
    ), /* @__PURE__ */ React.createElement(
      "a",
      {
        ...
        onClick: () => {
          if (window.umami) {
            try {
              window.umami.track("cockpit_cta_clicked", { target: "invitation", motto: mottoId });
            } catch (e) {
            }
          }
        },
      ...
      /* @__PURE__ */ React.createElement("span", { style: { fontSize: 22 } }, "\u{1F4E8}"),
      /* @__PURE__ */ React.createElement("span", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("strong", { style: { fontSize: 14, color: "var(--d)", display: "block" } }, "Einladung erstellen"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: "var(--m)" } }, "WhatsApp-Einladung mit Mini-Spiel zum Motto")),
      /* @__PURE__ */ React.createElement("span", { style: { fontSize: 18, color: "var(--a)" } }, "\u2192")
    ), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          if (window.umami) {
            try {
              window.umami.track("cockpit_cta_clicked", { target: "party", motto: mottoId });
            } catch (e) {
            }
          }
          openPartyForm();
      ...
      if (window.umami) {
        try {
          window.umami.track("shopping_package_selected", { theme: mottoId, package: val });
        } catch (e) {
        }
      }
    }, style: {
      ...
      transition: "all .2s",
      whiteSpace: "nowrap"
    } }, ico, " ", label))))), /* @__PURE__ */ React.createElement(Zeitplan, { timeline, mottoColor: motto.color, quietMode, setQuietMode, ageGroupLabel: ageLabel[ag] }), eliteData && eliteData.variants && /* @__PURE__ */ React.createElement(
      EliteGamesFilter,
      {
    ...
    ), /* @__PURE__ */ React.createElement("div", { "data-section": "schatzsuche" }, /* @__PURE__ */ React.createElement(SchnitzeljagdBlock, { age, ag, mottoId, szActive, setSzActive, szThemeId, setSzThemeId, szTheme, childName, setChildName, mapPositions, setMapPositions, stationLocations, setStationLocations, dekoEmojis, setDekoEmojis })), /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 20, fontWeight: 800, marginBottom: 12 } }, "\u{1F37F} Was du wirklich an Essen brauchst ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, fontWeight: 500, color: "var(--m)" } }, "(f\xFCr ", guests, " Kinder, ", duration, " Std.)")), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(140px, 1fr))", gap: 8 } }, snacks.map((s, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { background: "var(--bg)", borderRadius: "var(--rs)", padding: "10px 12px", border: "1px solid var(--l)", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, marginBottom: 4 } }, s.emoji), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: "var(--d)" } }, s.name), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 800, color: "var(--a)", marginTop: 2 } }, s.menge))))), eliteData && eliteData.variants && /* @__PURE__ */ React.createElement(EliteShoppingList, { variants: eliteData.variants, shoppingMode, mottoColor: motto.color }), !eliteData && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 20, fontWeight: 800, marginBottom: 4 } }, "\u{1F3A8} Deko, die man wirklich sieht ", motto.cat === "license" && `(${motto.name})`), isMinimal && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--g)", marginBottom: 10, fontWeight: 600 } }, "\u{1F33F} Minimal-Modus: Das reicht v\xF6llig."), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "var(--m)", marginBottom: 8 } }, '\u2713 Checkbox = "Hab ich schon" \u2014 wird aus Kosten rausgerechnet'), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, deko.map((item, i) => /* @__PURE__ */ React.createElement(ItemRow, { key: i, item, isOwned: owned[i], onToggle: () => toggleOwned(i) })))), /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 20, fontWeight: 800, marginBottom: 12 } }, "\u{1F381} Kleine Mitgebsel, kein unn\xF6tiger Kram"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, mitgebsel.map((item, i) => /* @__PURE__ */ React.createElement(ItemRow, { key: "m" + i, item, isOwned: owned[deko.length + i], onToggle: () => toggleOwned(deko.length + i) }))))), /* @__PURE__ */ React.createElement("div", { className: "sp", style: { background: "linear-gradient(135deg,#1B5E20,#2E7D32,#388E3C)", borderRadius: 24, padding: "48px 24px 40px", textAlign: "center", position: "relative", overflow: "hidden", marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", zIndex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 64, marginBottom: 12, animation: "checkPop .6s ease .3s both" } }, "\u2713"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: "clamp(26px,5vw,34px)", fontWeight: 900, color: "#FFF", marginBottom: 8, lineHeight: 1.1 } }, "Das reicht. Wirklich."), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 16, color: "#C8E6C9", marginBottom: 24, lineHeight: 1.7, maxWidth: 420, margin: "0 auto 24px" } }, "Du musst jetzt nichts mehr optimieren. Dieser Plan funktioniert."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", gap: 32, flexWrap: "wrap", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#A5D6A7", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Noch einkaufen"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--fd)", fontSize: 28, fontWeight: 800, color: "#FFF" } }, "ca. \u20AC", Math.round(total))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#A5D6A7", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Pro Kind"), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--fd)", fontSize: 28, fontWeight: 800, color: "#F7C948" } }, "ca. \u20AC", guests > 0 ? Math.round(total / guests) : "0"))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "#A5D6A7" } }, "Richtwerte \u2014 tats\xE4chliche Preise variieren"))), /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 16, textAlign: "center", padding: "4px 0" } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 15, fontFamily: "var(--fd)", fontWeight: 800, color: "var(--d)" } }, "Plan steht \u2014 jetzt einladen & teilen")), /* @__PURE__ */ React.createElement(EinladungBlock, { motto, guests, previewName, setPreviewName, inviteSent, setInviteSent }), /* @__PURE__ */ React.createElement("section", { className: "fu", style: { marginBottom: 24, borderRadius: 20, border: "2px solid #25D36630", background: "linear-gradient(135deg, #f0fdf4 0%, #fff 100%)", padding: "18px 16px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 28, marginBottom: 4 } }, "\u{1F4F1}"), /* @__PURE__ */ React.createElement("h3", { style: { fontFamily: "var(--fd)", fontSize: 16, marginBottom: 4, color: "var(--m)" } }, "WhatsApp-Partyseite"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: "var(--m)", marginBottom: 10, lineHeight: 1.4 } }, "Zusagen, Wunschliste, Abholzeit \u2014 alles auf einer Seite. Link in die Familiengruppe, fertig."), /* @__PURE__ */ React.createElement("a", { href: `https://party.machsleicht.de?${new URLSearchParams({ ...childName ? { childName } : {}, ...age ? { age } : {}, ...motto?.name ? { motto: motto.name } : {}, ...motto?.emoji ? { mottoEmoji: motto.emoji } : {} }).toString()}`, target: "_blank", rel: "noopener", style: { display: "inline-flex", alignItems: "center", gap: 6, padding: "12px 24px", background: "#25D366", color: "#fff", borderRadius: 16, fontSize: 14, fontWeight: 700, fontFamily: "var(--f)", textDecoration: "none", boxShadow: "0 2px 8px #25D36640" } }, "\u{1F4F1} Partyseite erstellen \u2192"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: "var(--m)", marginTop: 8, opacity: 0.7 } }, "Kostenlos \xB7 Daten werden vorausgef\xFCllt")), /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      fontSize: 14,
      cursor: "pointer"
    } }, "\u{1F4C4} PDF erstellen & drucken"))), /* @__PURE__ */ React.createElement("footer", { style: { textAlign: "center", marginTop: 32, padding: "16px 0", borderTop: "1px solid var(--l)" } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: "var(--m)" } }, "\xA9 2026 machsleicht.de \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/impressum", style: { color: "var(--m)", textDecoration: "none" } }, "Impressum"), " \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/datenschutz", style: { color: "var(--m)", textDecoration: "none" } }, "Datenschutz"), " \xB7 ", /* @__PURE__ */ React.createElement("a", { href: "/transparenz", style: { color: "var(--m)", textDecoration: "none" } }, "Transparenz"))), /* @__PURE__ */ React.createElement(ControlHub, { mottoId, szActive, setSzActive, setSzThemeId, childName, age, motto }), eliteData && eliteData.sosScenarios && /* @__PURE__ */ React.createElement(SOSButton, { sosScenarios: eliteData.sosScenarios, mottoColor: motto.color }));
  }
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("nav", { style: { position: "sticky", top: 0, zIndex: 100, background: "rgba(253,252,249,0.85)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", borderBottom: "1px solid rgba(0,0,0,0.05)", padding: "12px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("a", { href: "/", style: { textDecoration: "none", display: "flex", alignItems: "baseline", gap: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--fd)", fontWeight: 800, fontSize: 20, color: "var(--a)" } }, "mach's"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--fd)", fontWeight: 800, fontSize: 20, color: "var(--d)" } }, "leicht")), /* @__PURE__ */ React.createElement("a", { href: "/schatzsuche", style: { fontSize: 13, fontWeight: 500, color: "var(--m)", textDecoration: "none" } }, "\u{1F5FA}\uFE0F Schnitzeljagd")), /* @__PURE__ */ React.createElement("section", { style: { position: "relative", overflow: "hidden", padding: "48px 24px 32px", background: "linear-gradient(165deg, #fef8f0 0%, #fdfcf9 40%, #f0f4e8 100%)" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 660, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "inline-flex", alignItems: "center", gap: 6, background: "#fff", border: "1px solid var(--l)", borderRadius: 100, padding: "6px 16px", fontSize: 12, fontWeight: 500, color: "#888", marginBottom: 20, animation: "fadeSlideUp 0.4s ease-out both" } }, "\u{1F389} Kindergeburtstag planen \u2014 kostenlos, ohne Anmeldung"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--fd)", fontSize: "clamp(28px,5.5vw,48px)", fontWeight: 800, lineHeight: 1.12, marginBottom: 14, color: "var(--d)", animation: "fadeSlideUp 0.5s 0.1s ease-out both" } }, "Kindergeburtstag planen", /* @__PURE__ */ React.createElement("br", null), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--a)" } }, "in 10 Minuten.")), /* @__PURE__ */ React.createElement("p", { style: { fontSize: "clamp(14px,2vw,17px)", color: "var(--m)", lineHeight: 1.6, maxWidth: 500, margin: "0 auto 24px", animation: "fadeSlideUp 0.5s 0.2s ease-out both" } }, "W\xE4hl Alter, Motto und G\xE4stezahl \u2014 du bekommst sofort einen kompletten Plan mit Spielen, Einkaufsliste und Kosten pro Kind."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 8, justifyContent: "center", animation: "fadeSlideUp 0.5s 0.3s ease-out both" } }, [["\u23F1\uFE0F", "Zeitplan"], ["\u{1F3AF}", "Altersgerechte Spiele"], ["\u{1F6D2}", "Einkaufsliste"], ["\u{1F5FA}\uFE0F", "+ Schnitzeljagd"]].map(([ico, label]) => /* @__PURE__ */ React.createElement("span", { key: label, style: { display: "inline-flex", alignItems: "center", gap: 5, padding: "6px 12px", background: "rgba(255,255,255,0.7)", backdropFilter: "blur(8px)", borderRadius: 100, fontSize: 12, fontWeight: 500, color: "#4a4a4a", border: "1px solid rgba(0,0,0,0.06)" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14 } }, ico), label))))), emergencyMode && /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 700, margin: "16px auto", padding: "0 16px" } }, /* @__PURE__ */ React.createElement("div", { style: { background: "linear-gradient(135deg,#FFEBEE,#FFF3E0)", borderRadius: 20, padding: 24, border: "2px solid #EF5350", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 36, marginBottom: 8 } }, "\u{1F6A8}"), /* @__PURE__ */ React.createElement("h2", { style: { fontFamily: "var(--fd)", fontSize: 22, fontWeight: 900, color: "#C62828", marginBottom: 8 } }, "Morgen-Modus aktiv"), /* @__PURE__ */ React.createElement("p", { style: { fontSize: 14, color: "var(--m)", lineHeight: 1.6, marginBottom: 16 } }, "Schnellster Plan der funktioniert. Drinnen, minimal, 2 Stunden."), /* @__PURE__ */ React.createElement("button", { onClick: () => setEmergencyMode(false), style: { background: "none", border: "none", fontSize: 12, color: "var(--m)", cursor: "pointer", textDecoration: "underline" } }, "Morgen-Modus deaktivieren"))), /* @__PURE__ */ React.createElement("div", { id: "wizard", style: { maxWidth: 700, margin: "-16px auto 0", padding: "0 16px", position: "relative", zIndex: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { background: "#fff", borderRadius: 24, padding: "32px 28px 28px", boxShadow: "0 8px 40px rgba(0,0,0,0.06), 0 1px 3px rgba(0,0,0,0.04)", border: "1px solid rgba(0,0,0,0.04)" } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em", color: "#bbb", marginBottom: 10 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--a)", marginRight: 6 } }, "\u2460"), " Wie alt wird dein Kind?", /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--fd)", fontSize: 18, fontWeight: 800, color: "var(--a)", marginLeft: 8 } }, age, " Jahre"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "var(--m)", fontWeight: 500, marginLeft: 6 } }, "(", ageLabel[ag], ")")), /* @__PURE__ */ React.createElement("input", { type: "range", min: 3, max: 12, value: age, onChange: (e) => {
    ...
    cursor: "pointer"
  } }, label)))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(90px, 1fr))", gap: 6 } }, (mottoTab === "generic" ? GENERIC : filteredLicense).map((m) => /* @__PURE__ */ React.createElement("button", { key: m.id, onClick: () => {
    setMottoId(m.id);
    ...
    cursor: "pointer",
    transition: "all 0.2s"
  } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 24 } }, m.emoji), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 600, color: mottoId === m.id ? m.color : "#666" } }, m.name), m.cat === "license" && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, color: mottoId === m.id ? m.color : "#999", background: mottoId === m.id ? m.color + "15" : "#f5f5f5", padding: "1px 6px", borderRadius: 100 } }, m.ages[0], "\u2013", m.ages[m.ages.length - 1], " J."), mottoId === m.id && /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: -5, right: -5, width: 18, height: 18, borderRadius: "50%", background: m.color, color: "#fff", fontSize: 10, fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: `0 2px 8px ${m.color}50` } }, "\u2713"))), mottoTab === "license" && filteredLicense.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: 16, color: "var(--m)", fontSize: 13 } }, "F\xFCr ", age, " Jahre keine Lizenz-Mottos verf\xFCgbar."))), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 24 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em", color: "#bbb", marginBottom: 10 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--a)", marginRight: 6 } }, "\u2462"), " G\xE4stezahl", guests && /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--fd)", fontSize: 18, fontWeight: 800, color: "var(--a)", marginLeft: 8 } }, guests, " Kinder")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } }, [4, 5, 6, 7, 8, 10, 12, 15].map((n) => /* @__PURE__ */ React.createElement("button", { key: n, onClick: () => setGuests(n), style: {
    width: 48,
    height: 48,
