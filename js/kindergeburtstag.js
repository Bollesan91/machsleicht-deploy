...
const MAP_THEMES = {
  ...
  einhorn: { parchment: ["#F8F0FF", "#F0E4FF", "#E4D4FF"], accent: "#7B1FA2", pathColor: "rgba(123,31,162,0.3)", borderColor: "#9C27B0", scatter: ["\u{1F984}", "\u{1F984}", "\u{1F308}", "\u{1F308}", "\u2B50", "\u2728", "\u2728", "\u{1F496}", "\u{1F49C}", "\u{1F338}", "\u{1F380}", "\u{1F48E}", "\u{1FAE7}", "\u{1F31F}", "\u{1F4AB}"], pathDeco: ["\u2728", "\u{1F308}", "\u{1F496}", "\u2B50"], treasureIcon: "\u{1F48E}", startIcon: "\u{1F984}" },
  feuerwehr: { parchment: ["#FFF0E6", "#FFE4D0", "#FFD4B8"], accent: "#C62828", pathColor: "rgba(198,40,40,0.35)", borderColor: "#D32F2F", scatter: ["\u{1F525}", "\u{1F525}", "\u{1F692}", "\u{1F692}", "\u{1F9EF}", "\u{1FA9C}", "\u{1F468}\u200D\u{1F692}", "\u{1F3E2}", "\u{1F4A7}", "\u{1F4A7}", "\u{1F6A8}", "\u{1F4DF}", "\u{1F514}", "\u{1FAA3}", "\u{1F525}"], pathDeco: ["\u{1F525}", "\u{1F4A7}", "\u{1F6A8}", "\u{1F9EF}"], treasureIcon: "\u{1F3C5}", startIcon: "\u{1F692}" }
};
