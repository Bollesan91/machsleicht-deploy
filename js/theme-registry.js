...
(function() {
  ...
  var WIZARD_OVERRIDES = {
    ...
    feuerwehr:    {accent:'#C62828', accent2:'#FFCDD2', persona:'Feuerwehrkid',   darkAccent:'#1F0A0A', wizardReady:false, inviteTpl:{title:'🚨 Alarm!',                     body:'{name} wird {age} — wir brauchen dich im Einsatzteam!'}},
    ...
    meerjungfrau: {accent:'#01579B', accent2:'#B3E5FC', persona:'Meerwesen',      darkAccent:'#0A1A2A', wizardReady:false, inviteTpl:{title:'🧜 Aus der Tiefe',              body:'{name} laedt dich ein — tauch mit ab in das Reich der Meerjungfrauen!'}},
