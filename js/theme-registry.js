...
(function() {
  ...
  var THEMES = {
    ...
    superheld: {
      ...
      emoji: '\u{1F9B8}',
      color: '#EF5350',
      modules: ['planner', 'treasure', 'invitation'],
      licenseRisk: 'none',
      treasureUrl: '/schatzsuche/superheld',
      plannerUrl: '/kindergeburtstag/superheld',
    ...
    prinzessin: {
      ...
      modules: ['planner', 'treasure', 'invitation'],
      licenseRisk: 'none',
      treasureUrl: '/schatzsuche/prinzessin',
      plannerUrl: '/kindergeburtstag/prinzessin',
  ...
  var WIZARD_OVERRIDES = {
    ...
    prinzessin:   {accent:'#AD1457', accent2:'#FCE4EC', persona:'Hoheit',         darkAccent:'#2A0E1F', wizardReady:true,  inviteTpl:{title:'👑 Koenigliche Einladung',     body:'{name} laedt zur Schloss-Feier ein — Hoheit, wir bitten Sie zur Audienz!'}},
    ...
    superheld:    {accent:'#1565C0', accent2:'#FFD600', persona:'Superheld',      darkAccent:'#0A1A2A', wizardReady:true,  inviteTpl:{title:'🦸 Super-Mission!',             body:'{name} wird {age} — die Welt braucht deine Hilfe als Superheld!'}},
