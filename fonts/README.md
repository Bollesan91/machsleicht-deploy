...
```
npx wrangler kv key put "font:baloo2"   --path fonts/baloo2.woff2   --binding PARTY --remote
npx wrangler kv key put "font:dmsans"   --path fonts/dmsans.woff2   --binding PARTY --remote
npx wrangler kv key put "font:fraunces" --path fonts/fraunces.woff2 --binding PARTY --remote
```
