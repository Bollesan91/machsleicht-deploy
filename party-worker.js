...
// Geparkt (NICHT im Katalog): wappen-ritter, puzzle-dschungel (Bild-Puzzle vs. reveal-last-Konflikt, Bolle 10.07.).
const IND_GAMES = {"piraten":["kanone","flaschenpost","memory"],"dino":["ei","faehrte","fossil"],"safari":["fotosafari","jeep","spuren"],"weltraum":["funk","rakete","sternbild"],"detektiv":["akte","fingerabdruck","wimmel"],"superheld":["signal","stadt","strahl"],"prinzessin":["tatort","tresor","uvschrift"],"einhorn":["regenbogen","sternenstaub","turm"],"meerjungfrau":["korallen","perlen","schatz"],"feuerwehr":["drehleiter","loeschen","notruf"],"baustelle":["bagger","hochhaus","rohre"],"dschungel":["lianen","wildnis"],"feen":["gluehwuermchen","laterne","taunetz"],"pferde":["huerden","hufeisen","striegeln"],"ritter":["katapult","schwert"]};
const GAME_CATALOG = (() => {
  const c = {};
