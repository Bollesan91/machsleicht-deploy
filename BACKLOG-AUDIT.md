...
| M-4 | ⏳ | **Zwei Inhaltsquellen zusammenführen (Voraussetzung für M-1).** Die Motto-Seite führt fünf Stationen mit Altersvarianten, `data/motto/*.json` führt eigene Spiele mit eigenen Namen. **72 % der Spiele aus den Daten sind auf ihrer Seite nicht auffindbar** (176 von 244). Deshalb ist der abgeleitete Beispiel-Ablauf am 01.09. wieder entfernt worden — der Erzeuger `_dev/scripts/gen-ablauf.mjs` und Stufe 63 bleiben und funktionieren, sobald die Namen zusammenpassen. Entscheidung nötig: welche Quelle führt? | 1–2 Tage |
