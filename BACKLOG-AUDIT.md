...
| H-2 | ⏳ | **Cache-Buster älter als der Code.** Alle 60 core-Spiele laden `core/core.js?v=20260802`; `core.js` wurde am **27.08.** geändert (`280d82e9`, „Gutachten 46/100 abgearbeitet: fünf Blocker zu“). Beim CSS dasselbe bei 45 von 60 (`?v=20260708`, Datei zuletzt 12.07.). Wer im August ein Spiel geöffnet hat, bekommt die alte Datei — fünf gegatete Blocker-Fixes erreichen ihre Nutzer möglicherweise nicht. **Hannes' Zone.** | 1 Std |
