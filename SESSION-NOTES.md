...
- **🔄 narrow-Batch-H IN FLIGHT (SHA `8507669`, ChatGPT-Limit geklärt):** schatz/memory/wappen (alle no-Teaser). claude.ai: schatz `f2d62398` (T311), memory `cec06905` (T314), wappen `73440c21` (T315). ChatGPT: schatz T316/`82a2e1bc6977a12d659ac6406a89327d`, memory T317/`675df626b3f82d8315fb2c451adab137`, wappen T318/`75733f45544363f1bd521aae10f110db`. Alle 6 userMsgs:1.
