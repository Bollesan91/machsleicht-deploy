...
**⚠️ ChatGPT-ZWEITWINKEL via raw-URLs FUNKTIONIERT NICHT** (10.07.): strahl-ChatGPT `6a507caa` lieferte nur „GO" + GitHub-Zitat-Rauschen (188 Zeichen, keine Analyse) = KEIN gültiger Zweitwinkel. ChatGPT browst raw-GitHub schlecht. **Fix für ChatGPT-Doppelcheck: Code INLINE einfügen (Spiel-HTML ist self-contained ~60KB) ODER Gist mit Zeilen-Markern** (s. [[chatgpt_doublecheck_method]]). ChatGPT-Half des Doppelchecks daher noch NICHT gültig erledigt — Methode umstellen.
