...
- **🔄 narrow-Batch-C IN FLIGHT (SHA `7f65371`):** spuren/tatort (mp=False, f>=1-Branch — reveal via sharpen(1), Prompt sagt reviewer „by design kein magicFly") + wildnis (magicFly Vollfeld-Foto+faceguard). claude.ai: spuren `c71b950d` (T311), tatort `200c9943` (T314), wildnis `13a56078` (T315). ChatGPT (Gists): spuren T316/`0d9129ef063cc1dc56f18c0468620aaa`, tatort T317/`eff2e8bde84f377f7b15e3af5c0d00ba`, wildnis T318/`bcfac72d9fef6b541f1232506c9929e1`. Alle 6 userMsgs:1. Nächster Tick: 6 lesen + Stufe-3. **Offene #80-Frage:** spuren/tatort/signal/uvschrift = mp=False (sharpen(1)-Reveal, KEIN hüpfendes magicFly-Foto). signal/uvschrift wurden so schon gegatet → mp=False-Reveal ist gate-fähig. Ob Bolle das hüpfende Foto auch in die mp=False-Spiele nachrüsten will = offene Entscheidung (uniformer Pass, nicht gate-blockend).
